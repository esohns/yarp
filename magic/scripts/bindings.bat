...
"E:\ACE_wrappers\bin\generate_export_file.pl" -n RPG_Magic > .\..\rpg_magic_exports.h

@rem C++ "glue code"
"E:\XML2CppCode\Debug\XML2CppCode.exe" -d -e -f .\..\rpg_magic.xsd -i -o .\.. -s -u
...
"E:\Program Files\CodeSynthesis XSD 3.3\bin\xsd.exe" cxx-parser --type-map ..\rpg_magic.map --char-type char --output-dir .\.. --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc ..\rpg_magic.xsd
