...
class RPG_Magic_Spell_EffectHelper
{
 public:
  inline static void init()
  {
    ...
    myRPG_Magic_Spell_EffectToStringTable.insert(std::make_pair(SPELLEFFECT_CONSECRATE, ACE_TEXT_ALWAYS_CHAR("SPELLEFFECT_CONSECRATE")));
    ...
    myRPG_Magic_Spell_EffectToStringTable.insert(std::make_pair(SPELLEFFECT_DESECRATE, ACE_TEXT_ALWAYS_CHAR("SPELLEFFECT_DESECRATE")));
