...
class RPG_Magic_Spell_EffectHelper
{
 public:
  inline static void init()
  {
    ...
    myRPG_Magic_Spell_EffectToStringTable.insert(std::make_pair(SPELLEFFECT_ANIMATE_ANIMAL_PLANT, ACE_TEXT_ALWAYS_CHAR("SPELLEFFECT_ANIMATE_ANIMAL_PLANT")));
    ...
    myRPG_Magic_Spell_EffectToStringTable.insert(std::make_pair(SPELLEFFECT_BONUS_ATTACK_ROLL, ACE_TEXT_ALWAYS_CHAR("SPELLEFFECT_BONUS_ATTACK_ROLL")));
    ...
    myRPG_Magic_Spell_EffectToStringTable.insert(std::make_pair(SPELLEFFECT_BONUS_SAVE_FEAR, ACE_TEXT_ALWAYS_CHAR("SPELLEFFECT_BONUS_SAVE_FEAR")));
