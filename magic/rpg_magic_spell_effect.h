...
class RPG_Magic_Spell_EffectHelper
{
 public:
  inline static void init()
  {
    ...
    myRPG_Magic_Spell_EffectToStringTable.insert(std::make_pair(SPELLEFFECT_REPEL_CREATURE, ACE_TEXT_ALWAYS_CHAR("SPELLEFFECT_REPEL_CREATURE")));
