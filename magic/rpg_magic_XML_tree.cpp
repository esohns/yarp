...
void RPG_Magic_Spell_Type_XMLTree_Type::
school (::std::unique_ptr< school_type > x)
{
  this->school_.set (std::move (x));
}
...
void RPG_Magic_Spell_Type_XMLTree_Type::
subSchool (::std::unique_ptr< subSchool_type > x)
{
  this->subSchool_.set (std::move (x));
}
...
void RPG_Magic_Spell_Type_XMLTree_Type::
counterSpell (::std::unique_ptr< counterSpell_type > x)
{
  this->counterSpell_.set (std::move (x));
}
...
void RPG_Magic_Spell_Level_XMLTree_Type::
casterClass (::std::unique_ptr< casterClass_type > x)
{
  this->casterClass_.set (std::move (x));
}
...
void RPG_Magic_CounterMeasure_XMLTree_Type::
reduction (::std::unique_ptr< reduction_type > x)
{
  this->reduction_.set (std::move (x));
}
...
void RPG_Magic_Spell_EffectProperties_XMLTree_Type::
levelIncrement (::std::unique_ptr< levelIncrement_type > x)
{
  this->levelIncrement_.set (std::move (x));
}
...
void RPG_Magic_Spell_EffectProperties_XMLTree_Type::
creature (::std::unique_ptr< creature_type > x)
{
  this->creature_.set (std::move (x));
}
...
void RPG_Magic_Spell_PropertiesXML_XMLTree_Type::
saveable (::std::unique_ptr< saveable_type > x)
{
  this->saveable_.set (std::move (x));
}
...
void RPG_Magic_SpellLikeProperties_XMLTree_Type::
save (::std::unique_ptr< save_type > x)
{
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< school_type > r (
        school_traits::create (i, f, this));

      if (!school_.present ())
      {
        this->school_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< subSchool_type > r (
        subSchool_traits::create (i, f, this));

      if (!this->subSchool_)
      {
        this->subSchool_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< casterClass_type > r (
        casterClass_traits::create (i, f, this));

      if (!casterClass_.present ())
      {
        this->casterClass_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< creature_type > r (
        creature_traits::create (i, f, this));

      this->creature_.push_back (::std::move (r));
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "levelIncrement" && n.namespace_ () == "urn:rpg")
    {
      ::std::unique_ptr< levelIncrement_type > r (
        levelIncrement_traits::create (i, f, this));

      if (!this->levelIncrement_)
      {
        this->levelIncrement_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< counterMeasure_type > r (
        counterMeasure_traits::create (i, f, this));

      this->counterMeasure_.push_back (::std::move (r));
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "effect" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->effect_.push_back (::std::move (r));
      continue;
    }
                 ...
                 const ::xml_schema::properties& p)
{
  ...
  return ::std::unique_ptr< ::RPG_Magic_Dictionary_XMLTree_Type > (
    ::spellDictionary (
                 ...
                 const ::xml_schema::properties& p)
{
  ...
  {
    ::std::unique_ptr< ::RPG_Magic_Dictionary_XMLTree_Type > r (
...
operator<< (::xercesc::DOMElement& e, const RPG_Magic_Spell_Type_XMLTree_Type& i)
{
  ...
  for (RPG_Magic_Spell_Type_XMLTree_Type::descriptor_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_Type_XMLTree_Type::descriptor_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Magic_Spell_PreconditionProperties_XMLTree_Type& i)
{
  ...
  for (RPG_Magic_Spell_PreconditionProperties_XMLTree_Type::creature_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_PreconditionProperties_XMLTree_Type::creature_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Magic_CounterMeasure_XMLTree_Type& i)
{
  ...
  for (RPG_Magic_CounterMeasure_XMLTree_Type::spell_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_CounterMeasure_XMLTree_Type::spell_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Magic_Spell_EffectProperties_XMLTree_Type& i)
{
  ...
  for (RPG_Magic_Spell_EffectProperties_XMLTree_Type::precondition_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_EffectProperties_XMLTree_Type::precondition_type& x (*b);
  ...
  for (RPG_Magic_Spell_EffectProperties_XMLTree_Type::counterMeasure_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_EffectProperties_XMLTree_Type::counterMeasure_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Magic_Spell_PropertiesXML_XMLTree_Type& i)
{
  ...
  for (RPG_Magic_Spell_PropertiesXML_XMLTree_Type::level_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_PropertiesXML_XMLTree_Type::level_type& x (*b);
  ...
  for (RPG_Magic_Spell_PropertiesXML_XMLTree_Type::target_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_PropertiesXML_XMLTree_Type::target_type& x (*b);
  ...
  for (RPG_Magic_Spell_PropertiesXML_XMLTree_Type::precondition_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_PropertiesXML_XMLTree_Type::precondition_type& x (*b);
  ...
  for (RPG_Magic_Spell_PropertiesXML_XMLTree_Type::effect_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_PropertiesXML_XMLTree_Type::effect_type& x (*b);
  ...
  for (RPG_Magic_Spell_PropertiesXML_XMLTree_Type::counterMeasure_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Spell_PropertiesXML_XMLTree_Type::counterMeasure_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Magic_Dictionary_XMLTree_Type& i)
{
  ...
  for (RPG_Magic_Dictionary_XMLTree_Type::spell_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Magic_Dictionary_XMLTree_Type::spell_type& x (*b);
