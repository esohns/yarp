...
class RPG_Magic_SpellHelper
{
 public:
  inline static void init()
  {
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_ALIGN_WEAPON, ACE_TEXT_ALWAYS_CHAR("SPELL_ALIGN_WEAPON")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_BLADE_BARRIER, ACE_TEXT_ALWAYS_CHAR("SPELL_BLADE_BARRIER")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_BLASPHEMY, ACE_TEXT_ALWAYS_CHAR("SPELL_BLASPHEMY")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_BLESS, ACE_TEXT_ALWAYS_CHAR("SPELL_BLESS")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_BLINK, ACE_TEXT_ALWAYS_CHAR("SPELL_BLINK")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_CALL_LIGHTNING, ACE_TEXT_ALWAYS_CHAR("SPELL_CALL_LIGHTNING")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_CHARM_MONSTER, ACE_TEXT_ALWAYS_CHAR("SPELL_CHARM_MONSTER")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_COMMUNE, ACE_TEXT_ALWAYS_CHAR("SPELL_COMMUNE")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_DETECT_MAGIC, ACE_TEXT_ALWAYS_CHAR("SPELL_DETECT_MAGIC")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_DISCERN_LOCATION, ACE_TEXT_ALWAYS_CHAR("SPELL_DISCERN_LOCATION")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_FEEBLEMIND, ACE_TEXT_ALWAYS_CHAR("SPELL_FEEBLEMIND")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_HEROISM, ACE_TEXT_ALWAYS_CHAR("SPELL_HEROISM")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_MAGIC_WEAPON, ACE_TEXT_ALWAYS_CHAR("SPELL_MAGIC_WEAPON")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_PROJECT_IMAGE, ACE_TEXT_ALWAYS_CHAR("SPELL_PROJECT_IMAGE")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_REVERSE_GRAVITY, ACE_TEXT_ALWAYS_CHAR("SPELL_REVERSE_GRAVITY")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_SCARE, ACE_TEXT_ALWAYS_CHAR("SPELL_SCARE")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_SLOW, ACE_TEXT_ALWAYS_CHAR("SPELL_SLOW")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_STINKING_CLOUD, ACE_TEXT_ALWAYS_CHAR("SPELL_STINKING_CLOUD")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_STONE_SHAPE, ACE_TEXT_ALWAYS_CHAR("SPELL_STONE_SHAPE")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_SUMMON_MONSTER_I, ACE_TEXT_ALWAYS_CHAR("SPELL_SUMMON_MONSTER_I")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_SUMMON_MONSTER_IV, ACE_TEXT_ALWAYS_CHAR("SPELL_SUMMON_MONSTER_IV")));
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_SUMMON_MONSTER_V, ACE_TEXT_ALWAYS_CHAR("SPELL_SUMMON_MONSTER_V")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_TONGUES, ACE_TEXT_ALWAYS_CHAR("SPELL_TONGUES")));
    ...
    myRPG_Magic_SpellToStringTable.insert(std::make_pair(SPELL_UNHOLY_BLIGHT, ACE_TEXT_ALWAYS_CHAR("SPELL_UNHOLY_BLIGHT")));
  };
