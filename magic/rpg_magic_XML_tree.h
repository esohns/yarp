...
#ifndef CXX__MAGIC_ETC_RPG_MAGIC_XML_TREE_H
#define CXX__MAGIC_ETC_RPG_MAGIC_XML_TREE_H
...
class RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type;
...
class RPG_Magic_School_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_School_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_SubSchool_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_SubSchool_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Descriptor_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Descriptor_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Domain_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Domain_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_SpellType_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_SpellType_XMLTree_Type&) = default;
#endif
  ...
  public:
  static const char* const _xsd_RPG_Magic_SpellType_XMLTree_Type_literals_[235];
...
class RPG_Magic_AbilityClass_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_AbilityClass_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_AbilityType_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_AbilityType_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Spell_Type_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  school (::std::unique_ptr< school_type > p);
  ...
  void
  subSchool (::std::unique_ptr< subSchool_type > p);
  ...
  void
  counterSpell (::std::unique_ptr< counterSpell_type > p);
...
class RPG_Magic_CasterClassUnion_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_CasterClassUnion_XMLTree_Type&) = default;
#endif
  ...
  public:
  static const char* const _xsd_RPG_Magic_CasterClassUnion_XMLTree_Type_literals_[33];
...
class RPG_Magic_Spell_Level_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  casterClass (::std::unique_ptr< casterClass_type > p);
...
class RPG_Magic_Spell_RangeEffect_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Spell_RangeEffect_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Spell_Target_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Spell_Target_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Spell_AreaOfEffect_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Spell_AreaOfEffect_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Spell_TargetProperties_XMLTree_Type: public ::xml_schema::type
{
  ...
  // target
  //
  typedef ::RPG_Magic_Spell_Target_XMLTree_Type target_type;
  ...
  // shapeable
  //
  typedef ::xml_schema::boolean shapeable_type;
  typedef ::xsd::cxx::tree::traits< shapeable_type, char > shapeable_traits;

  const shapeable_type&
  shapeable () const;
  ...
  //
  typedef ::xml_schema::boolean incrementIsReciprocal_type;
  typedef ::xsd::cxx::tree::traits< incrementIsReciprocal_type, char > incrementIsReciprocal_traits;

  const incrementIsReciprocal_type&
  incrementIsReciprocal () const;

  incrementIsReciprocal_type&
  incrementIsReciprocal ();

  void
  incrementIsReciprocal (const incrementIsReciprocal_type& x);

  static incrementIsReciprocal_type
  ...
  static const target_type target_default_value_;
  ::xsd::cxx::tree::one< shapeable_type > shapeable_;
...
class RPG_Magic_Spell_Duration_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Spell_Duration_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_Spell_DurationProperties_XMLTree_Type: public ::RPG_Common_EffectDuration_XMLTree_Type
{
  ...
  // duration
  //
  typedef ::RPG_Magic_Spell_Duration_XMLTree_Type duration_type;
  ...
  static const duration_type duration_default_value_;
...
class RPG_Magic_Spell_Precondition_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Spell_Precondition_XMLTree_Type&) = default;
#endif
  ...
  public:
  static const char* const _xsd_RPG_Magic_Spell_Precondition_XMLTree_Type_literals_[19];
...
class RPG_Magic_Spell_Effect_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_Spell_Effect_XMLTree_Type&) = default;
#endif
  ...
  public:
  static const char* const _xsd_RPG_Magic_Spell_Effect_XMLTree_Type_literals_[100];
...
class RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type: public ::xml_schema::string
{
  ...
  RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type (const RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type& x,
                                                ::xml_schema::flags f = 0,
                                                ::xml_schema::container* c = 0);

#ifdef XSD_CXX11
  RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type&
  operator= (const RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type&) = default;
#endif

  virtual RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type*
  _clone (::xml_schema::flags f = 0,
          ::xml_schema::container* c = 0) const;
  ...
  operator value () const
  {
    return _xsd_RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type_convert ();
  }
...
class RPG_Magic_CheckTypeUnion_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Magic_CheckTypeUnion_XMLTree_Type&) = default;
#endif
...
class RPG_Magic_CounterMeasure_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  check (::std::unique_ptr< check_type > p);
  ...
  void
  reduction (::std::unique_ptr< reduction_type > p);
...
class RPG_Magic_Spell_EffectProperties_XMLTree_Type: public ::xml_schema::type
{
  ...
  // damage
  //
  typedef ::RPG_Magic_Spell_DamageTypeUnion_XMLTree_Type damage_type;
  ...
  void
  damage (::std::unique_ptr< damage_type > p);
  ...
  void
  levelIncrement (::std::unique_ptr< levelIncrement_type > p);
  ...
  //
  typedef ::RPG_Common_CreatureType_XMLTree_Type creature_type;
  typedef ::xsd::cxx::tree::optional< creature_type > creature_optional;
  typedef ::xsd::cxx::tree::traits< creature_type, char > creature_traits;

  const creature_optional&
  creature () const;
  ...
  void
  creature (::std::unique_ptr< creature_type > p);

  // duration
  //
  typedef ::RPG_Common_EffectDuration_XMLTree_Type duration_type;
...
class RPG_Magic_Spell_PropertiesXML_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  saveable (::std::unique_ptr< saveable_type > p);
...
class RPG_Magic_SpellLikeProperties_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  save (::std::unique_ptr< save_type > p);
...
::std::unique_ptr< ::RPG_Magic_Dictionary_XMLTree_Type >
...
::std::unique_ptr< ::RPG_Magic_Dictionary_XMLTree_Type >
spellDictionary (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
                 ::xml_schema::flags f = 0,
                 const ::xml_schema::properties& p = ::xml_schema::properties ());
...
#endif // CXX__MAGIC_ETC_RPG_MAGIC_XML_TREE_H
