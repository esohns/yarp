...
RPG_Magic_School
RPG_Magic_School_Type::post_RPG_Magic_School_Type ()
{
...
RPG_Magic_SubSchool
RPG_Magic_SubSchool_Type::post_RPG_Magic_SubSchool_Type ()
{
...
RPG_Magic_Descriptor
RPG_Magic_Descriptor_Type::post_RPG_Magic_Descriptor_Type ()
{
...
RPG_Magic_Domain
RPG_Magic_Domain_Type::post_RPG_Magic_Domain_Type ()
{
...
RPG_Magic_SpellType
RPG_Magic_SpellType_Type::post_RPG_Magic_SpellType_Type ()
{
...
RPG_Magic_AbilityClass
RPG_Magic_AbilityClass_Type::post_RPG_Magic_AbilityClass_Type ()
{
...
RPG_Magic_AbilityType
RPG_Magic_AbilityType_Type::post_RPG_Magic_AbilityType_Type ()
{
...
void
RPG_Magic_Spell_Type_Type::type (const RPG_Magic_SpellType& type_in)
{
...
void
RPG_Magic_Spell_Type_Type::school (const RPG_Magic_School& school_in)
{
...
void
RPG_Magic_Spell_Type_Type::subSchool (const RPG_Magic_SubSchool& subSchool_in)
{
...
void
RPG_Magic_Spell_Type_Type::descriptor (const RPG_Magic_Descriptor& descriptor_in)
{
...
void
RPG_Magic_Spell_Type_Type::counterSpell (const RPG_Magic_SpellType& counterSpell_in)
{
...
RPG_Magic_Spell_Type
RPG_Magic_Spell_Type_Type::post_RPG_Magic_Spell_Type_Type ()
{
...
void
RPG_Magic_CasterClassUnion_Type::_characters (const ::xml_schema::ro_string& casterClass_in)
{
...
RPG_Magic_CasterClassUnion
RPG_Magic_CasterClassUnion_Type::post_RPG_Magic_CasterClassUnion_Type ()
{
...
void
RPG_Magic_Spell_Level_Type::casterClass (const RPG_Magic_CasterClassUnion& casterClass_in)
{
...
void
RPG_Magic_Spell_Level_Type::level (unsigned char level_in)
{
...
RPG_Magic_Spell_Level
RPG_Magic_Spell_Level_Type::post_RPG_Magic_Spell_Level_Type ()
{
...
void
RPG_Magic_Spell_CastingTime_Type::rounds (unsigned int rounds_in)
{
...
void
RPG_Magic_Spell_CastingTime_Type::action (const RPG_Common_ActionType& action_in)
{
...
RPG_Magic_Spell_CastingTime
RPG_Magic_Spell_CastingTime_Type::post_RPG_Magic_Spell_CastingTime_Type ()
{
...
RPG_Magic_Spell_RangeEffect
RPG_Magic_Spell_RangeEffect_Type::post_RPG_Magic_Spell_RangeEffect_Type ()
{
...
void
RPG_Magic_Spell_RangeProperties_Type::maximum (unsigned int max_in)
{
...
void
RPG_Magic_Spell_RangeProperties_Type::increment (unsigned int increment_in)
{
...
void
RPG_Magic_Spell_RangeProperties_Type::effect (const RPG_Magic_Spell_RangeEffect& effect_in)
{
...
RPG_Magic_Spell_RangeProperties
RPG_Magic_Spell_RangeProperties_Type::post_RPG_Magic_Spell_RangeProperties_Type ()
{
...
RPG_Magic_Spell_Target
RPG_Magic_Spell_Target_Type::post_RPG_Magic_Spell_Target_Type ()
{
...
RPG_Magic_Spell_AreaOfEffect
RPG_Magic_Spell_AreaOfEffect_Type::post_RPG_Magic_Spell_AreaOfEffect_Type ()
{
...
void
RPG_Magic_Spell_TargetProperties_Type::base (const RPG_Common_Amount& amount_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::levelIncrement (unsigned char levelIncrement_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::levelIncrementMax (unsigned char levelIncrementMax_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::radius (unsigned int radius_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::height (unsigned int height_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::effect (const RPG_Magic_Spell_AreaOfEffect& effect_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::shape (const RPG_Common_AreaOfEffect& shape_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::target (const RPG_Magic_Spell_Target& target_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::shapeable (bool shapeable_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::rangeIsInHD (bool rangeIsInHD_in)
{
...
void
RPG_Magic_Spell_TargetProperties_Type::incrementIsReciprocal (bool incrementIsReciprocal_in)
{
...
RPG_Magic_Spell_TargetProperties
RPG_Magic_Spell_TargetProperties_Type::post_RPG_Magic_Spell_TargetProperties_Type ()
{
...
RPG_Magic_Spell_Duration
RPG_Magic_Spell_Duration_Type::post_RPG_Magic_Spell_Duration_Type ()
{
...
void
RPG_Magic_Spell_DurationProperties_Type::base (const RPG_Common_Amount& amount_in)
{
...
void
RPG_Magic_Spell_DurationProperties_Type::levelIncrement (signed char levelIncrement_in)
{
...
void
RPG_Magic_Spell_DurationProperties_Type::levelIncrementMax (unsigned char levelIncrementMax_in)
{
...
void
RPG_Magic_Spell_DurationProperties_Type::reciprocalIncrement (unsigned char increment_in)
{
...
RPG_Common_EffectDuration
RPG_Magic_Spell_DurationProperties_Type::post_RPG_Common_EffectDuration_Type ()
{
...
void
RPG_Magic_Spell_DurationProperties_Type::duration (const RPG_Magic_Spell_Duration& duration_in)
{
...
void
RPG_Magic_Spell_DurationProperties_Type::dismissible (bool dismissible_in)
{
...
RPG_Magic_Spell_DurationProperties
RPG_Magic_Spell_DurationProperties_Type::post_RPG_Magic_Spell_DurationProperties_Type ()
{
...
RPG_Magic_Spell_Precondition
RPG_Magic_Spell_Precondition_Type::post_RPG_Magic_Spell_Precondition_Type ()
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::type (const RPG_Magic_Spell_Precondition& type_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::value (int value_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::levelIncrement (unsigned char levelIncrement_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::levelIncrementMax (unsigned char levelIncrementMax_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::alignment (const RPG_Character_Alignment& alignment_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::attribute (const RPG_Common_Attribute& attribute_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::condition (const RPG_Common_Condition& condition_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::creature (const RPG_Common_CreatureType& creature_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::size (const RPG_Common_Size& size_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::environment (const RPG_Common_Environment& environment_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::reverse (bool reverse_in)
{
...
void
RPG_Magic_Spell_PreconditionProperties_Type::baseIsCasterLevel (bool baseIsCasterLevel_in)
{
...
RPG_Magic_Spell_PreconditionProperties
RPG_Magic_Spell_PreconditionProperties_Type::post_RPG_Magic_Spell_PreconditionProperties_Type ()
{
...
RPG_Magic_Spell_Effect
RPG_Magic_Spell_Effect_Type::post_RPG_Magic_Spell_Effect_Type ()
{
...
void
RPG_Magic_Spell_DamageTypeUnion_Type::_characters (const ::xml_schema::ro_string& damageType_in)
{
...
RPG_Magic_Spell_DamageTypeUnion
RPG_Magic_Spell_DamageTypeUnion_Type::post_RPG_Magic_Spell_DamageTypeUnion_Type()
{
...
void
RPG_Magic_CheckTypeUnion_Type::_characters (const ::xml_schema::ro_string& checkType_in)
{
...
RPG_Magic_CheckTypeUnion
RPG_Magic_CheckTypeUnion_Type::post_RPG_Magic_CheckTypeUnion_Type ()
{
...
void
RPG_Magic_Check_Type::type (const RPG_Magic_CheckTypeUnion& checkUnion_in)
{
...
void
RPG_Magic_Check_Type::difficultyClass (unsigned char difficultyClass_in)
{
...
void
RPG_Magic_Check_Type::modifier (signed char modifier_in)
{
...
void
RPG_Magic_Check_Type::levelIncrementMax (unsigned char incrementMax_in)
{
...
void
RPG_Magic_Check_Type::baseIsCasterLevel (bool isCasterLevel_in)
{
...
RPG_Magic_Check
RPG_Magic_Check_Type::post_RPG_Magic_Check_Type ()
{
...
void
RPG_Magic_CounterMeasure_Type::type (const RPG_Common_CounterMeasure& type_in)
{
...
void
RPG_Magic_CounterMeasure_Type::check (const RPG_Magic_Check& check_in)
{
...
void
RPG_Magic_CounterMeasure_Type::spell (const RPG_Magic_SpellType& spell_in)
{
...
void
RPG_Magic_CounterMeasure_Type::reduction (const RPG_Common_SaveReductionType& reduction_in)
{
...
RPG_Magic_CounterMeasure
RPG_Magic_CounterMeasure_Type::post_RPG_Magic_CounterMeasure_Type ()
{
...
void
RPG_Magic_Spell_EffectProperties_Type::type (const RPG_Magic_Spell_Effect& type_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::damage (const RPG_Magic_Spell_DamageTypeUnion& damageType_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::base (const RPG_Common_Amount& base_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::increment (unsigned int increment_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::levelIncrement (const RPG_Common_Amount& levelIncrement_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::levelIncrementMax (unsigned char levelIncrementMax_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::attribute (const RPG_Common_Attribute& attribute_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::domain (const RPG_Magic_Domain& domain_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::creature (const RPG_Common_CreatureType& type_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::duration (const RPG_Common_EffectDuration& duration_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::precondition (const RPG_Magic_Spell_PreconditionProperties& precondition_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::maxRange (unsigned char maxRange_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::counterMeasure (const RPG_Magic_CounterMeasure& counterMeasure_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::includeAdjacent (bool includeAdjacent_in)
{
...
void
RPG_Magic_Spell_EffectProperties_Type::incrementIsReciprocal (bool incrementIsReciprocal_in)
{
...
RPG_Magic_Spell_EffectProperties
RPG_Magic_Spell_EffectProperties_Type::post_RPG_Magic_Spell_EffectProperties_Type ()
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::name (const ::std::string& name_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::type (const RPG_Magic_Spell_Type& type_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::level (const RPG_Magic_Spell_Level& level_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::cost (unsigned int cost_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::time (const RPG_Magic_Spell_CastingTime& time_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::range (const RPG_Magic_Spell_RangeProperties& range_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::target (const RPG_Magic_Spell_TargetProperties& target_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::duration (const RPG_Magic_Spell_DurationProperties& duration_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::precondition (const RPG_Magic_Spell_PreconditionProperties& precondition_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::effect (const RPG_Magic_Spell_EffectProperties& effect_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::counterMeasure (const RPG_Magic_CounterMeasure& counterMeasure_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::saveable (const RPG_Common_SavingThrow& saveable_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::resistible (bool resistible_in)
{
...
void
RPG_Magic_Spell_PropertiesXML_Type::effectsAreInclusive (bool effectsAreInclusive_in)
{
...
RPG_Magic_Spell_PropertiesXML
RPG_Magic_Spell_PropertiesXML_Type::post_RPG_Magic_Spell_PropertiesXML_Type ()
{
...
void
RPG_Magic_SpellLikeProperties_Type::type (const RPG_Magic_SpellType& type_in)
{
...
void
RPG_Magic_SpellLikeProperties_Type::casterLevel (unsigned char casterLevel_in)
{
...
void
RPG_Magic_SpellLikeProperties_Type::duration (const RPG_Common_Duration& duration_in)
{
...
void
RPG_Magic_SpellLikeProperties_Type::save (const RPG_Common_SavingThrowCheck& save_in)
{
...
RPG_Magic_SpellLikeProperties
RPG_Magic_SpellLikeProperties_Type::post_RPG_Magic_SpellLikeProperties_Type ()
{
...
void
RPG_Magic_Dictionary_Type::spell (const RPG_Magic_Spell_PropertiesXML& spell_in)
{
...
void RPG_Magic_Dictionary_Type::post_RPG_Magic_Dictionary_Type ()
{
  ...
  ACE_DEBUG ((LM_DEBUG,
              ACE_TEXT ("finished parsing spell dictionary, retrieved %u spell types...\n"),
              myDictionary->size ()));
}
