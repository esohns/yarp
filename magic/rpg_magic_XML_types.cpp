...
abilityClass_parser (::RPG_Magic_SpecialAbilityClass_Type_pskel& p)
{
  this->abilityClass_parser_ = &p;
}

void RPG_Magic_SpecialAbilityProperties_Type_pskel::
type_parser (::RPG_Magic_SpecialAbility_Type_pskel& p)
{
  this->type_parser_ = &p;
}
...
bool RPG_Magic_SpecialAbilityProperties_Type_pskel::
                   ...
                   const ::xml_schema::ro_string& n)
{
  ...
  {
    if (this->abilityClass_parser_)
      this->abilityClass (this->abilityClass_parser_->post_RPG_Magic_SpecialAbilityClass_Type ());
