...
#include "rpg_net_stream_asynch_udpsocket_base.h"
#include "rpg_net_stream_tcpsocket_base.h"
#include "rpg_net_stream_udpsocket_base.h"
...
typedef RPG_Net_StreamAsynchTCPSocketBase<RPG_Net_ConfigPOD,
                                          RPG_Net_RuntimeStatistic,
                                          RPG_Net_Stream,
                                          RPG_Net_AsynchTCPSocketHandler> RPG_Net_AsynchTCPHandler;
typedef RPG_Net_StreamAsynchUDPSocketBase<RPG_Net_ConfigPOD,
                                          RPG_Net_RuntimeStatistic,
                                          RPG_Net_Stream,
                                          ACE_SOCK_Dgram,
...
typedef RPG_Net_StreamTCPSocketBase<RPG_Net_ConfigPOD,
                                    RPG_Net_RuntimeStatistic,
                                    RPG_Net_Stream,
                                    RPG_Net_TCPSocketHandler> RPG_Net_TCPHandler;
typedef RPG_Net_StreamUDPSocketBase<RPG_Net_ConfigPOD,
                                    RPG_Net_RuntimeStatistic,
                                    RPG_Net_Stream,
                                    ACE_SOCK_Dgram,
