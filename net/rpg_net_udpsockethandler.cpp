...
RPG_Net_UDPSocketHandler::RPG_Net_UDPSocketHandler()//MANAGER_T* manager_in)
 //: inherited ()
...
{
  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::RPG_Net_UDPSocketHandler"));
...
RPG_Net_UDPSocketHandler::~RPG_Net_UDPSocketHandler()
{
  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::~RPG_Net_UDPSocketHandler"));
...
//RPG_Net_UDPSocketHandler::add_reference(void)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::add_reference"));
//
//  inherited2::increase();
//
...
//
//ACE_Event_Handler::Reference_Count
//RPG_Net_UDPSocketHandler::remove_reference(void)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::remove_reference"));
//
...
int
RPG_Net_UDPSocketHandler::open(void* arg_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::open"));
...
int
RPG_Net_UDPSocketHandler::handle_close(ACE_HANDLE handle_in,
                                       ACE_Reactor_Mask mask_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::handle_close"));
...
//void
//RPG_Net_UDPSocketHandler::info(ACE_HANDLE& handle_out,
//                               ACE_INET_Addr& localSAP_out,
//                               ACE_INET_Addr& remoteSAP_out) const
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::info"));
...
//void
//RPG_Net_UDPSocketHandler::close()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::close"));
...
//unsigned int
//RPG_Net_UDPSocketHandler::id() const
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::id"));
...
//void
//RPG_Net_UDPSocketHandler::increase()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::increase"));
//
//  inherited2::increase();
...
//
//void
//RPG_Net_UDPSocketHandler::decrease()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::decrease"));
//
//  // *NOTE*: may "delete this"
//  inherited2::decrease();
//  //// *NOTE*: may "delete this"
...
//void
//RPG_Net_UDPSocketHandler::dump_state() const
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_UDPSocketHandler::dump_state"));
//
