...
#ifndef RPG_Net_Protocol_MessageHandler_H
#define RPG_Net_Protocol_MessageHandler_H
...
class RPG_Net_Protocol_MessageHandler
                                         ...
                                         struct Stream_UserData>
{
 ...
 public:
  RPG_Net_Protocol_MessageHandler (ISTREAM_T*); // stream handle
  inline virtual ~RPG_Net_Protocol_MessageHandler () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (RPG_Net_Protocol_MessageHandler ())
  ACE_UNIMPLEMENTED_FUNC (RPG_Net_Protocol_MessageHandler (const RPG_Net_Protocol_MessageHandler&))
  ACE_UNIMPLEMENTED_FUNC (RPG_Net_Protocol_MessageHandler& operator= (const RPG_Net_Protocol_MessageHandler&))
};
...
DATASTREAM_MODULE_INPUT_ONLY (struct RPG_Net_Protocol_SessionData,                // session data type
                              ...
                              RPG_Net_Protocol_MessageHandler);                   // writer type
