...
/usr/bin/flex++ -L --never-interactive -d --header=rpg_net_protocol_IRCbisect.h -o rpg_net_protocol_IRCbisect.cpp ./IRCbisect.ll
...
/usr/bin/flex -L --never-interactive -d --header=rpg_net_protocol_IRCscanner.h -o rpg_net_protocol_IRCscanner.cpp ./IRCscanner.ll
