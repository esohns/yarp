...
/usr/bin/bison --language=C++ --skeleton="lalr1.cc" --debug --locations --no-lines --token-table --defines --verbose --defines=rpg_net_protocol_IRCparser.h --output=rpg_net_protocol_IRCparser.cpp ./IRCparser.ypp
