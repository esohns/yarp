...
RPG_Net_TCPConnection::RPG_Net_TCPConnection()
{
  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::RPG_Net_TCPConnection"));
...
void
RPG_Net_TCPConnection::info (ACE_HANDLE& handle_out,
                             ACE_INET_Addr& localSAP_out,
                             ACE_INET_Addr& remoteSAP_out) const
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_TCPConnection::info"));
...
//int
//RPG_Net_TCPConnection::svc(void)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::svc"));
//
//  ACE_DEBUG((LM_DEBUG,
...
//
//int
//RPG_Net_TCPConnection::open(void* arg_in)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::open"));
//
...
//
//int
//RPG_Net_TCPConnection::close(u_long arg_in)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::close"));
...
int
RPG_Net_TCPConnection::handle_close(ACE_HANDLE handle_in,
                                    ACE_Reactor_Mask mask_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::handle_close"));
...
//void
//RPG_Net_TCPConnection::shutdown()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::shutdown"));
//
...
RPG_Net_AsynchTCPConnection::RPG_Net_AsynchTCPConnection ()
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_AsynchTCPConnection::RPG_Net_AsynchTCPConnection"));
...
//int
//RPG_Net_AsynchTCPConnection::svc(void)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_TCPConnection::svc"));
//
//  ACE_DEBUG((LM_DEBUG,
...
//
//int
//RPG_Net_AsynchTCPConnection::open(void* arg_in)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_AsynchTCPConnection::open"));
//
//  // step1: init/start stream, tweak socket, register reading data with reactor
//  // , ...
//  int result = inherited::open(arg_in);
...
//
//int
//RPG_Net_AsynchTCPConnection::close(u_long arg_in)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_AsynchTCPConnection::close"));
//  // [*NOTE*: hereby we override the default behavior of a ACE_Svc_Handler,
//  // which would call handle_close() AGAIN]
//
//  // *NOTE*: this method will be invoked
...
int
RPG_Net_AsynchTCPConnection::handle_close (ACE_HANDLE handle_in,
                                           ACE_Reactor_Mask mask_in)
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_AsynchTCPConnection::handle_close"));
...
//void
//RPG_Net_AsynchTCPConnection::shutdown()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_AsynchTCPConnection::shutdown"));
//
//  ACE_Message_Block* stop_mb = NULL;
//  ACE_NEW_NORETURN(stop_mb,
//                   ACE_Message_Block(0,                                  // size
