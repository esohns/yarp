...
RPG_Net_SocketConnectionBase<SocketHandlerType,
                             TransportLayerType,
                             ConfigurationType,
                             StatisticsContainerType>::RPG_Net_SocketConnectionBase()
 : inherited ()
 //, inherited2 ()
 , inherited3(RPG_NET_CONNECTIONMANAGER_SINGLETON::instance())
{
  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::RPG_Net_SocketConnectionBase"));
...
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_SocketConnectionBase::ping"));
...
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_SocketConnectionBase::id"));
  ...
  {
    ACE_DEBUG ((LM_ERROR,
                ACE_TEXT ("failed to RPG_Net_ITransportLayer::info(), aborting\n")));
    return -1;
  } // end catch
...
{
  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::dump_state"));
...
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_SocketConnectionBase::collect"));

  try
  {
    return inherited::myStream.collect (data_out);
  }
  catch (...)
  {
    ACE_DEBUG ((LM_ERROR,
...
{
  RPG_TRACE (ACE_TEXT ("RPG_Net_SocketConnectionBase::report"));

  try
  {
    return inherited::myStream.report ();
  }
  catch (...)
  {
    ACE_DEBUG ((LM_ERROR,
...
//          typename StatisticsContainerType>
//void
//RPG_Net_SocketConnectionBase::RPG_Net_SocketConnectionBase::ping()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::ping"));
...
//          typename StatisticsContainerType>
//int
//RPG_Net_SocketConnectionBase::svc(void)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::svc"));
//
//  ACE_DEBUG((LM_DEBUG,
...
//          typename StatisticsContainerType>
//int
//RPG_Net_SocketConnectionBase::open(void* arg_in)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::open"));
//
...
//          typename StatisticsContainerType>
//int
//RPG_Net_SocketConnectionBase::close(u_long arg_in)
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::close"));
...
{
  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::handle_close"));
...
//          typename StatisticsContainerType>
//void
//RPG_Net_SocketConnectionBase::shutdown()
//{
//  RPG_TRACE(ACE_TEXT("RPG_Net_SocketConnectionBase::shutdown"));
//
