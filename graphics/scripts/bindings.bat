...
%PerlEXE% %PerlScript% -n RPG_Graphics > .\graphics\rpg_graphics_exports.h
if %ERRORLEVEL% NEQ 0 (
...
%XML2CppCodeEXE% -e -f .\graphics\etc\rpg_graphics.xsd -i -o .\graphics -s -u -x RPG_Graphics
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-parser --type-map .\graphics\etc\rpg_graphics.map --output-dir .\graphics --cxx-prologue-file .\graphics\stdafx.cpp --options-file .\scripts\xsdcxx_parser_options .\graphics\etc\rpg_graphics.xsd
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-tree --output-dir .\graphics --cxx-prologue-file .\graphics\stdafx.cpp --options-file .\scripts\xsdcxx_tree_options .\graphics\etc\rpg_graphics.xsd
if %ERRORLEVEL% NEQ 0 (
