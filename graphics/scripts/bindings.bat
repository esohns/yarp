...
"E:\ACE_wrappers\bin\generate_export_file.pl" -n RPG_Graphics > .\..\rpg_graphics_exports.h

@rem C++ "glue code"
"E:\XML2CppCode\Debug\XML2CppCode.exe" -d RPG_Graphics_Export -e -f .\..\rpg_graphics.xsd -i -o .\.. -s -u -x RPG_Graphics
...
"E:\Program Files\CodeSynthesis XSD 3.3\bin\xsd.exe" cxx-parser --type-map ..\rpg_graphics.map --char-type char --output-dir .\.. --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc --export-symbol "RPG_Graphics_Export" --hxx-prologue "#include \"rpg_graphics_exports.h\"" ..\rpg_graphics.xsd
