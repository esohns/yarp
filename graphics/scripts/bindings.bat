...
%XML2CppCodeEXE% -d RPG_Graphics_Export -e -f .\..\rpg_graphics.xsd -i -o .\.. -s -u -x RPG_Graphics
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-parser --type-map ..\rpg_graphics.map --output-dir .\.. --export-symbol "RPG_Graphics_Export" --hxx-prologue "#include \"rpg_graphics_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\scripts\xsdcxx_parser_options ..\rpg_graphics.xsd
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-tree --output-dir .\.. --export-symbol "RPG_Graphics_Export" --hxx-prologue "#include \"rpg_graphics_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\scripts\xsdcxx_tree_options ..\rpg_graphics.xsd
if %ERRORLEVEL% NEQ 0 (
