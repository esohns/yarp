...
class RPG_Graphics_Tile_XMLTree_Type: public ::xml_schema::type
{
  ...
  file_optional file_;
  ::xsd::cxx::tree::one< offsetX_type > offsetX_;
  static const offsetX_type offsetX_default_value_;
  ::xsd::cxx::tree::one< offsetY_type > offsetY_;
  static const offsetY_type offsetY_default_value_;
  ::xsd::cxx::tree::one< open_type > open_;
  static const open_type open_default_value_;
  ::xsd::cxx::tree::one< broken_type > broken_;
  static const broken_type broken_default_value_;
};
...
class RPG_Graphics_TileSet_XMLTree_Type: public ::xml_schema::type
{
  ...
  static const half_type half_default_value_;
};
