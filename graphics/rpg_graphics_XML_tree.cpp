...
void RPG_Graphics_Style_XMLTree_Type::
edge (::std::unique_ptr< edge_type > x)
{
  this->edge_.set (std::move (x));
}
...
void RPG_Graphics_Style_XMLTree_Type::
wall (::std::unique_ptr< wall_type > x)
{
  this->wall_.set (std::move (x));
}
...
void RPG_Graphics_Style_XMLTree_Type::
door (::std::unique_ptr< door_type > x)
{
  this->door_.set (std::move (x));
}
...
void RPG_Graphics_Element_XMLTree_Type::
window (::std::unique_ptr< window_type > x)
{
...
void RPG_Graphics_Tile_XMLTree_Type::
style (::std::unique_ptr< style_type > x)
{
...
void RPG_Graphics_Graphic_XMLTree_Type::
tile (::std::unique_ptr< tile_type > x)
{
  this->tile_.set (std::move (x));
}
...
void RPG_Graphics_Graphic_XMLTree_Type::
tileset (::std::unique_ptr< tileset_type > x)
{
  this->tileset_.set (std::move (x));
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< door_type > r (
        door_traits::create (i, f, this));

      if (!door_.present ())
      {
        this->door_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< window_type > r (
        window_traits::create (i, f, this));

      if (!this->window_)
      {
        this->window_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< tile_type > r (
        tile_traits::create (i, f, this));

      this->tile_.push_back (::std::move (r));
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< tileset_type > r (
        tileset_traits::create (i, f, this));

      if (!this->tileset_)
      {
        this->tileset_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< graphic_type > r (
        graphic_traits::create (i, f, this));

      this->graphic_.push_back (::std::move (r));
      continue;
    }
                    ...
                    const ::xml_schema::properties& p)
{
  ...
  return ::std::unique_ptr< ::RPG_Graphics_Dictionary_XMLTree_Type > (
    ::graphicsDictionary (
                    ...
                    const ::xml_schema::properties& p)
{
  ...
  {
    ::std::unique_ptr< ::RPG_Graphics_Dictionary_XMLTree_Type > r (
...
operator<< (::xercesc::DOMElement& e, const RPG_Graphics_TileSet_XMLTree_Type& i)
{
  ...
  for (RPG_Graphics_TileSet_XMLTree_Type::tile_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Graphics_TileSet_XMLTree_Type::tile_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Graphics_Graphic_XMLTree_Type& i)
{
  ...
  for (RPG_Graphics_Graphic_XMLTree_Type::element_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Graphics_Graphic_XMLTree_Type::element_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Graphics_Dictionary_XMLTree_Type& i)
{
  ...
  for (RPG_Graphics_Dictionary_XMLTree_Type::graphic_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Graphics_Dictionary_XMLTree_Type::graphic_type& x (*b);
