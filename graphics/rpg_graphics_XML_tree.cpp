...
RPG_Graphics_StyleUnion_XMLTree_Type::
RPG_Graphics_StyleUnion_XMLTree_Type (const char* s)
: ::xml_schema::string (s)
{
}
...
RPG_Graphics_StyleUnion_XMLTree_Type::
RPG_Graphics_StyleUnion_XMLTree_Type (const RPG_Graphics_StyleUnion_XMLTree_Type& o,
                                      ::xml_schema::flags f,
                                      ::xml_schema::container* c)
...
RPG_Graphics_GraphicTypeUnion_XMLTree_Type::
RPG_Graphics_GraphicTypeUnion_XMLTree_Type (const char* s)
: ::xml_schema::string (s)
{
}
...
RPG_Graphics_GraphicTypeUnion_XMLTree_Type::
RPG_Graphics_GraphicTypeUnion_XMLTree_Type (const RPG_Graphics_GraphicTypeUnion_XMLTree_Type& o,
                                            ::xml_schema::flags f,
                                            ::xml_schema::container* c)
: ::xml_schema::string (o, f, c)
{
...
RPG_Graphics_ElementTypeUnion_XMLTree_Type::
RPG_Graphics_ElementTypeUnion_XMLTree_Type (const char* s)
: ::xml_schema::string (s)
{
}
...
RPG_Graphics_ElementTypeUnion_XMLTree_Type::
RPG_Graphics_ElementTypeUnion_XMLTree_Type (const RPG_Graphics_ElementTypeUnion_XMLTree_Type& o,
                                            ::xml_schema::flags f,
                                            ::xml_schema::container* c)
: ::xml_schema::string (o, f, c)
{
...
const RPG_Graphics_Tile_XMLTree_Type::offsetX_type RPG_Graphics_Tile_XMLTree_Type::offsetX_default_value_ (
  ::xsd::cxx::tree::traits< ::xml_schema::integer, char >::create (
    ::std::string ("0"), 0, 0, 0));

const RPG_Graphics_Tile_XMLTree_Type::offsetY_type RPG_Graphics_Tile_XMLTree_Type::offsetY_default_value_ (
  ::xsd::cxx::tree::traits< ::xml_schema::integer, char >::create (
    ::std::string ("0"), 0, 0, 0));

const RPG_Graphics_Tile_XMLTree_Type::open_type RPG_Graphics_Tile_XMLTree_Type::open_default_value_ (
  ::xsd::cxx::tree::traits< ::xml_schema::boolean, char >::create (
    ::std::string ("false"), 0, 0, 0));

const RPG_Graphics_Tile_XMLTree_Type::broken_type RPG_Graphics_Tile_XMLTree_Type::broken_default_value_ (
  ::xsd::cxx::tree::traits< ::xml_schema::boolean, char >::create (
    ::std::string ("false"), 0, 0, 0));
...
const RPG_Graphics_TileSet_XMLTree_Type::half_type RPG_Graphics_TileSet_XMLTree_Type::half_default_value_ (
  ::xsd::cxx::tree::traits< ::xml_schema::boolean, char >::create (
    ::std::string ("false"), 0, 0, 0));
...
const RPG_Graphics_Graphic_XMLTree_Type::size_type RPG_Graphics_Graphic_XMLTree_Type::size_default_value_ (
       ...
       ::xml_schema::flags f)
{
...

  {
    ...
    if (p)
    {
      ::std::auto_ptr< reference_type > r (new reference_type (s, f, this));
      this->reference_.set (r);
    }
  }

  {
    ...
    if (p)
    {
      ::std::auto_ptr< style_type > r (new style_type (s, f, this));
      this->style_.set (r);
    }
  }

  {
    ...
    if (p)
    {
      ::std::auto_ptr< orientation_type > r (new orientation_type (s, f, this));
      this->orientation_.set (r);
    }
  }
       ...
       ::xml_schema::flags f)
{
...

  {
    ...
    if (n > 0)
    {
      ...
      while (n--)
      {
        ::std::auto_ptr< tile_type > r (new tile_type (s, f, this));
        c.push_back (r);
      }
    }
  }
       ...
       ::xml_schema::flags f)
{
...

  {
    ...
    if (p)
    {
      ::std::auto_ptr< tileset_type > r (new tileset_type (s, f, this));
      this->tileset_.set (r);
    }
  }

  {
    ...
    if (n > 0)
    {
      ...
      while (n--)
      {
        ::std::auto_ptr< element_type > r (new element_type (s, f, this));
        c.push_back (r);
      }
    }
  }
...
{
  {
    ...
    if (n > 0)
    {
      ...
      while (n--)
      {
        ::std::auto_ptr< graphic_type > r (new graphic_type (s, f, this));
        c.push_back (r);
      }
    }
  }
