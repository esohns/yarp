...
class RPG_Graphics_Export RPG_Graphics_ColorName_Type_pskel: public virtual ::xml_schema::string_pskel
{
  public:
  // Parser callbacks. Override them in your implementation.
  //
...
class RPG_Graphics_Export RPG_Graphics_ColorRGBA_Type_pskel: public ::xml_schema::complex_content
{
  public:
  // Parser callbacks. Override them in your implementation.
  //
