...
#include "rpg_graphics_SDL_window_interface.h"
...
RPG_Graphics_SDL_WindowInterface::RPG_Graphics_SDL_WindowInterface(const RPG_Graphics_WindowType& type_in,
...
{
  RPG_TRACE(ACE_TEXT("RPG_Graphics_SDL_WindowInterface::RPG_Graphics_SDL_WindowInterface"));

  // (try to) load (interface) element graphics
  if (!loadGraphics(myElementGraphicsType))
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("failed to load interface graphics, returning\n")));
...
RPG_Graphics_SDL_WindowInterface::~RPG_Graphics_SDL_WindowInterface()
{
  RPG_TRACE(ACE_TEXT("RPG_Graphics_SDL_WindowInterface::~RPG_Graphics_SDL_WindowInterface"));
...
bool
RPG_Graphics_SDL_WindowInterface::loadGraphics(const RPG_Graphics_GraphicTypeUnion& type_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Graphics_SDL_WindowInterface::loadGraphics"));
