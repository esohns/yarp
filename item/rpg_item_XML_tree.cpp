...
void RPG_Item_BaseProperties_XMLTree_Type::
baseStorePrice (::std::unique_ptr< baseStorePrice_type > x)
{
  this->baseStorePrice_.set (std::move (x));
}
...
void RPG_Item_BaseProperties_XMLTree_Type::
costToCreate (::std::unique_ptr< costToCreate_type > x)
{
  this->costToCreate_.set (std::move (x));
}
...
void RPG_Item_PropertiesBase_XMLTree_Type::
aura (::std::unique_ptr< aura_type > x)
{
  this->aura_.set (std::move (x));
}
...
void RPG_Item_PropertiesBase_XMLTree_Type::
prerequisites (::std::unique_ptr< prerequisites_type > x)
{
  this->prerequisites_.set (std::move (x));
}
...
void RPG_Item_WeaponPropertiesBase_XMLTree_Type::
weaponClass (::std::unique_ptr< weaponClass_type > x)
{
  this->weaponClass_.set (std::move (x));
}
...
void RPG_Item_WeaponPropertiesBase_XMLTree_Type::
baseDamage (::std::unique_ptr< baseDamage_type > x)
{
  this->baseDamage_.set (std::move (x));
}
...
void RPG_Item_WeaponPropertiesBase_XMLTree_Type::
criticalHit (::std::unique_ptr< criticalHit_type > x)
{
  this->criticalHit_.set (std::move (x));
}
...
void RPG_Item_BaseXML_XMLTree_Type::
armor (::std::unique_ptr< armor_type > x)
{
  this->armor_.set (std::move (x));
}
...
RPG_Item_StorePrice_XMLTree_Type& RPG_Item_StorePrice_XMLTree_Type::
operator= (const RPG_Item_StorePrice_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->numGoldPieces_ = x.numGoldPieces_;
    this->numSilverPieces_ = x.numSilverPieces_;
  }
...
: ::xml_schema::type (),
  minToHitRoll_ (minToHitRoll, this),
  damageModifier_ (damageModifier, this)
{
}
...
RPG_Item_CriticalHitProperties_XMLTree_Type& RPG_Item_CriticalHitProperties_XMLTree_Type::
operator= (const RPG_Item_CriticalHitProperties_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->minToHitRoll_ = x.minToHitRoll_;
    this->damageModifier_ = x.damageModifier_;
  }
...
RPG_Item_CreationCost_XMLTree_Type& RPG_Item_CreationCost_XMLTree_Type::
operator= (const RPG_Item_CreationCost_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->numGoldPieces_ = x.numGoldPieces_;
    this->numExperiencePoints_ = x.numExperiencePoints_;
  }
...
: ::xml_schema::type (),
  baseWeight_ (baseWeight, this),
  baseStorePrice_ (baseStorePrice, this),
  costToCreate_ (this)
{
}
...
RPG_Item_BaseProperties_XMLTree_Type::
RPG_Item_BaseProperties_XMLTree_Type (const baseWeight_type& baseWeight,
                                      ::std::unique_ptr< baseStorePrice_type > baseStorePrice)
: ::xml_schema::type (),
  baseWeight_ (baseWeight, this),
  baseStorePrice_ (std::move (baseStorePrice), this),
  costToCreate_ (this)
{
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< baseStorePrice_type > r (
        baseStorePrice_traits::create (i, f, this));

      if (!baseStorePrice_.present ())
      {
        this->baseStorePrice_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< costToCreate_type > r (
        costToCreate_traits::create (i, f, this));

      if (!this->costToCreate_)
      {
        this->costToCreate_.set (::std::move (r));
        continue;
      }
    }
...
RPG_Item_BaseProperties_XMLTree_Type& RPG_Item_BaseProperties_XMLTree_Type::
operator= (const RPG_Item_BaseProperties_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->baseWeight_ = x.baseWeight_;
    this->baseStorePrice_ = x.baseStorePrice_;
    this->costToCreate_ = x.costToCreate_;
  }
...
RPG_Item_MagicalPrerequisites_XMLTree_Type& RPG_Item_MagicalPrerequisites_XMLTree_Type::
operator= (const RPG_Item_MagicalPrerequisites_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->minCasterLevel_ = x.minCasterLevel_;
  }
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< aura_type > r (
        aura_traits::create (i, f, this));

      if (!this->aura_)
      {
        this->aura_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< prerequisites_type > r (
        prerequisites_traits::create (i, f, this));

      if (!this->prerequisites_)
      {
        this->prerequisites_.set (::std::move (r));
        continue;
      }
    }
...
RPG_Item_PropertiesBase_XMLTree_Type& RPG_Item_PropertiesBase_XMLTree_Type::
operator= (const RPG_Item_PropertiesBase_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Item_BaseProperties_XMLTree_Type& > (*this) = x;
    this->aura_ = x.aura_;
    this->prerequisites_ = x.prerequisites_;
  }
...
RPG_Item_CommodityPropertiesBase_XMLTree_Type& RPG_Item_CommodityPropertiesBase_XMLTree_Type::
operator= (const RPG_Item_CommodityPropertiesBase_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Item_PropertiesBase_XMLTree_Type& > (*this) = x;
    this->type_ = x.type_;
...
: ::RPG_Item_PropertiesBase_XMLTree_Type (baseWeight,
  ...
  weaponClass_ (weaponClass, this),
  baseDamage_ (baseDamage, this),
  criticalHit_ (criticalHit, this),
  rangeIncrement_ (this),
  typeOfDamage_ (this),
  isNonLethal_ (isNonLethal_default_value (), this),
  isReachWeapon_ (isReachWeapon_default_value (), this),
  isDoubleWeapon_ (isDoubleWeapon_default_value (), this)
{
}
...
RPG_Item_WeaponPropertiesBase_XMLTree_Type (const baseWeight_type& baseWeight,
                                            ...
                                            const category_type& category,
                                            const weaponClass_type& weaponClass,
                                            ::std::unique_ptr< baseDamage_type > baseDamage,
                                            ::std::unique_ptr< criticalHit_type > criticalHit)
: ::RPG_Item_PropertiesBase_XMLTree_Type (baseWeight,
                                          std::move (baseStorePrice)),
  type_ (type, this),
  category_ (category, this),
  weaponClass_ (weaponClass, this),
  baseDamage_ (std::move (baseDamage), this),
  criticalHit_ (std::move (criticalHit), this),
  rangeIncrement_ (this),
  typeOfDamage_ (this),
  isNonLethal_ (isNonLethal_default_value (), this),
  isReachWeapon_ (isReachWeapon_default_value (), this),
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< weaponClass_type > r (
        weaponClass_traits::create (i, f, this));

      if (!weaponClass_.present ())
      {
        this->weaponClass_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< baseDamage_type > r (
        baseDamage_traits::create (i, f, this));

      if (!baseDamage_.present ())
      {
        this->baseDamage_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< criticalHit_type > r (
        criticalHit_traits::create (i, f, this));

      if (!criticalHit_.present ())
      {
        this->criticalHit_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< typeOfDamage_type > r (
        typeOfDamage_traits::create (i, f, this));

      this->typeOfDamage_.push_back (::std::move (r));
      continue;
    }
...
RPG_Item_WeaponPropertiesBase_XMLTree_Type& RPG_Item_WeaponPropertiesBase_XMLTree_Type::
operator= (const RPG_Item_WeaponPropertiesBase_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Item_PropertiesBase_XMLTree_Type& > (*this) = x;
    ...
    this->weaponClass_ = x.weaponClass_;
    this->baseDamage_ = x.baseDamage_;
    this->criticalHit_ = x.criticalHit_;
    this->rangeIncrement_ = x.rangeIncrement_;
    this->typeOfDamage_ = x.typeOfDamage_;
    this->isNonLethal_ = x.isNonLethal_;
    this->isReachWeapon_ = x.isReachWeapon_;
    this->isDoubleWeapon_ = x.isDoubleWeapon_;
  }
...
RPG_Item_WeaponPropertiesXML_XMLTree_Type& RPG_Item_WeaponPropertiesXML_XMLTree_Type::
operator= (const RPG_Item_WeaponPropertiesXML_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Item_WeaponPropertiesBase_XMLTree_Type& > (*this) = x;
    this->toHitModifier_ = x.toHitModifier_;
  }
...
: ::RPG_Item_PropertiesBase_XMLTree_Type (baseWeight,
  ...
  type_ (type, this),
  category_ (category, this),
  baseBonus_ (baseBonus, this),
  maxDexterityBonus_ (maxDexterityBonus, this),
  checkPenalty_ (checkPenalty, this),
  arcaneSpellFailure_ (arcaneSpellFailure, this),
  baseSpeed_ (baseSpeed, this)
{
}
...
: ::RPG_Item_PropertiesBase_XMLTree_Type (e, f | ::xml_schema::flags::base, c),
  ...
  category_ (this),
  baseBonus_ (this),
  maxDexterityBonus_ (this),
  checkPenalty_ (this),
  arcaneSpellFailure_ (this),
  baseSpeed_ (this)
{
  if ((f & ::xml_schema::flags::base) == 0)
  {
...
RPG_Item_ArmorPropertiesBase_XMLTree_Type& RPG_Item_ArmorPropertiesBase_XMLTree_Type::
operator= (const RPG_Item_ArmorPropertiesBase_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Item_PropertiesBase_XMLTree_Type& > (*this) = x;
    this->type_ = x.type_;
    this->category_ = x.category_;
    this->baseBonus_ = x.baseBonus_;
    this->maxDexterityBonus_ = x.maxDexterityBonus_;
    this->checkPenalty_ = x.checkPenalty_;
    this->arcaneSpellFailure_ = x.arcaneSpellFailure_;
    this->baseSpeed_ = x.baseSpeed_;
  }
...
RPG_Item_ArmorPropertiesXML_XMLTree_Type& RPG_Item_ArmorPropertiesXML_XMLTree_Type::
operator= (const RPG_Item_ArmorPropertiesXML_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Item_ArmorPropertiesBase_XMLTree_Type& > (*this) = x;
    this->defenseModifier_ = x.defenseModifier_;
  }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< armor_type > r (
        armor_traits::create (i, f, this));

      if (!this->armor_)
      {
        this->armor_.set (::std::move (r));
        continue;
      }
    }
...
RPG_Item_BaseXML_XMLTree_Type& RPG_Item_BaseXML_XMLTree_Type::
operator= (const RPG_Item_BaseXML_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
    this->type_ = x.type_;
    this->armor_ = x.armor_;
...
RPG_Item_InventoryXML_XMLTree_Type& RPG_Item_InventoryXML_XMLTree_Type::
operator= (const RPG_Item_InventoryXML_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "armor" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->armor_.push_back (::std::move (r));
      continue;
    }
    ...
    if (n.name () == "commodity" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->commodity_.push_back (::std::move (r));
      continue;
    }
    ...
    if (n.name () == "weapon" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->weapon_.push_back (::std::move (r));
      continue;
    }
...
RPG_Item_DictionaryXML_XMLTree_Type& RPG_Item_DictionaryXML_XMLTree_Type::
operator= (const RPG_Item_DictionaryXML_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::xml_schema::type& > (*this) = x;
...
operator<< (::xercesc::DOMElement& e, const RPG_Item_WeaponPropertiesBase_XMLTree_Type& i)
{
  ...
  for (RPG_Item_WeaponPropertiesBase_XMLTree_Type::typeOfDamage_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Item_WeaponPropertiesBase_XMLTree_Type::typeOfDamage_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Item_InventoryXML_XMLTree_Type& i)
{
  ...
  for (RPG_Item_InventoryXML_XMLTree_Type::item_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Item_InventoryXML_XMLTree_Type::item_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Item_DictionaryXML_XMLTree_Type& i)
{
  ...
  for (RPG_Item_DictionaryXML_XMLTree_Type::armor_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Item_DictionaryXML_XMLTree_Type::armor_type& x (*b);
  ...
  for (RPG_Item_DictionaryXML_XMLTree_Type::commodity_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Item_DictionaryXML_XMLTree_Type::commodity_type& x (*b);
  ...
  for (RPG_Item_DictionaryXML_XMLTree_Type::weapon_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Item_DictionaryXML_XMLTree_Type::weapon_type& x (*b);
