...
# C++ "glue code"
XML2CppCode -e -f ./item/rpg_item.xsd -i -o ./item -s -u -x RPG_Item
...
xsdcxx cxx-parser --type-map ./item/rpg_item.map --char-type char --output-dir ./item --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc ./item/rpg_item.xsd
[ $? -ne 0 ] && echo "ERROR: failed to xsdcxx, aborting" && exit 1
