...
xsdcxx cxx-parser --type-map ../rpg_item.map --char-type char --output-dir ./.. --namespace-map urn:rpg_chance_dice= --namespace-map urn:rpg_item= --xml-parser xerces --generate-validation --generate-noop-impl --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --impl-file-suffix _XML_parser_base --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc ../rpg_item.xsd
