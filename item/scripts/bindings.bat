...
C:\Perl\bin\perl.exe C:\Temp\ACE_wrappers\bin\generate_export_file.pl -n RPG_Item > .\..\rpg_item_exports.h

@rem C++ "glue code"
C:\Tools\XML2CppCode.exe -d RPG_Item_Export -e -f .\..\rpg_item.xsd -i -o .\.. -s -u -x RPG_Item
