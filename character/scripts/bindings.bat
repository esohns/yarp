...
C:\Perl\bin\perl.exe C:\Temp\ACE_wrappers\bin\generate_export_file.pl -n RPG_Character > .\..\rpg_character_exports.h

@rem C++ "glue code"
C:\Tools\XML2CppCode.exe -d RPG_Character_Export -e -f .\..\rpg_character.xsd -i -o .\.. -s -u -x RPG_Character
