...
%PerlEXE% %PerlScript% -n RPG_Character > .\..\rpg_character_exports.h
if %ERRORLEVEL% NEQ 0 (
...
%XML2CppCodeEXE% -d RPG_Character_Export -e -f .\..\rpg_character.xsd -i -o .\.. -s -u -x RPG_Character
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-parser --type-map ..\rpg_character.map --output-dir .\.. --export-symbol "RPG_Character_Export" --hxx-prologue "#include \"rpg_character_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\scripts\xsdcxx_parser_options ..\rpg_character.xsd
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-tree --output-dir .\.. --export-symbol "RPG_Character_Export" --hxx-prologue "#include \"rpg_character_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\scripts\xsdcxx_tree_options ..\rpg_character.xsd
if %ERRORLEVEL% NEQ 0 (
