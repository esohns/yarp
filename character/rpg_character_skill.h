...
class RPG_Character_SkillHelper
{
 public:
  inline static void init()
  {
    ...
    myRPG_Character_SkillToStringTable.insert(std::make_pair(SKILL_KNOWLEDGE_ARCHITECTURE_ENGINEERING, ACE_TEXT_ALWAYS_CHAR("SKILL_KNOWLEDGE_ARCHITECTURE_ENGINEERING")));
    ...
    myRPG_Character_SkillToStringTable.insert(std::make_pair(SKILL_KNOWLEDGE_NOBILITY_ROYALTY, ACE_TEXT_ALWAYS_CHAR("SKILL_KNOWLEDGE_NOBILITY_ROYALTY")));
