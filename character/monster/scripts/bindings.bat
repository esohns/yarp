...
C:\Perl\bin\perl.exe C:\Temp\ACE_wrappers\bin\generate_export_file.pl -n RPG_Monster > .\..\rpg_monster_exports.h

@rem C++ "glue code"
C:\Tools\XML2CppCode.exe -d RPG_Monster_Export -e -f .\..\rpg_monster.xsd -i -o .\.. -s -u -x RPG_Monster
