...
//   unsigned_int_pimpl                      levelAdjustment_p;
  ...
  dictionary_p.post_RPG_Monster_Dictionary_Type ();
   ...
   ACE_DEBUG ((LM_DEBUG,
               ACE_TEXT ("finished parsing monster dictionary file \"%s\"...\n"),
...
void
RPG_Monster_Dictionary::find (const struct RPG_Character_Alignment& alignment_in,
...
RPG_Monster_Dictionary::dump () const
{
       ...
       iterator++)
  {
    ACE_DEBUG ((LM_DEBUG,
                ...
                ACE_TEXT (RPG_Common_SizeHelper::RPG_Common_SizeToString ((iterator->second).size.size).c_str ()),
                ACE_TEXT (RPG_Common_Tools::toString ((iterator->second).type).c_str ()),
                ACE_TEXT (RPG_Dice_Common_Tools::toString ((iterator->second).hitDice).c_str ()),
                ...
                ACE_TEXT (RPG_Monster_Common_Tools::toString ((iterator->second).attack).c_str ()),
                ...
                ACE_TEXT (RPG_Character_Common_Tools::toString ((iterator->second).attributes).c_str ()),
                ACE_TEXT (RPG_Character_Skills_Common_Tools::toString ((iterator->second).skills).c_str ()),
                ACE_TEXT (RPG_Character_Skills_Common_Tools::toString ((iterator->second).feats).c_str ()),
                ACE_TEXT (RPG_Common_Tools::toString ((iterator->second).environment).c_str ()),
                ACE_TEXT (RPG_Monster_Common_Tools::toString ((iterator->second).organizations).c_str ()),
                (iterator->second).challengeRating,
                (iterator->second).treasureModifier,
                ACE_TEXT (RPG_Character_Common_Tools::toString ((iterator->second).alignment).c_str ()),
                ACE_TEXT (RPG_Monster_Common_Tools::toString ((iterator->second).advancements).c_str ()),
