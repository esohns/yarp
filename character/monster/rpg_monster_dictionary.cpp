...
RPG_Monster_Dictionary::dump() const
{
       ...
       iterator++)
  {
    ACE_DEBUG((LM_DEBUG,
               ...
               RPG_Common_Tools::toString((iterator->second).type).c_str(),
               RPG_Dice_Common_Tools::toString((iterator->second).hitDice).c_str(),
               ...
               RPG_Monster_Common_Tools::toString((iterator->second).attack).c_str(),
               ...
               RPG_Character_Common_Tools::toString((iterator->second).attributes).c_str(),
               RPG_Character_Skills_Common_Tools::toString((iterator->second).skills).c_str(),
               RPG_Character_Skills_Common_Tools::toString((iterator->second).feats).c_str(),
               RPG_Common_Tools::toString((iterator->second).environment).c_str(),
               RPG_Monster_Common_Tools::toString((iterator->second).organizations).c_str(),
               (iterator->second).challengeRating,
               (iterator->second).treasureModifier,
               RPG_Character_Common_Tools::toString((iterator->second).alignment).c_str(),
               RPG_Monster_Common_Tools::toString((iterator->second).advancements).c_str(),
