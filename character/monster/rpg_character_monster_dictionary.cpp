...
RPG_Character_Monster_Dictionary::RPG_Character_Monster_Dictionary()
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::RPG_Character_Monster_Dictionary"));
...
void
RPG_Character_Monster_Dictionary::init(const std::string& filename_in,
                             const bool& validateXML_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::init"));
  ...
  RPG_Character_Monster_NaturalArmorClass_Type             naturalArmorClass_p;
  naturalArmorClass_p.parsers(byte_p,
                              byte_p,
                              byte_p);

  RPG_Magic_AbilityClass_Type                    abilityClass_p;
  RPG_Character_Monster_SpecialPropertyTypeUnion_Type      specialPropertyTypeUnion_p;
  RPG_Common_ActionType_Type                     actionType_p;
  RPG_Common_Usage_Type                          usage_p;
  RPG_Character_Monster_SpecialBaseProperties_Type         specialBaseProperties_p;
  specialBaseProperties_p.parsers(abilityClass_p,
                                  specialPropertyTypeUnion_p,
                                  actionType_p,
                                  usage_p);

  RPG_Character_Monster_WeaponTypeUnion_Type               weaponUnion_p;
  RPG_Common_Condition_Type                      condition_p;
  ::xml_schema::boolean_pimpl                    bool_p;
  RPG_Character_Monster_SpecialDefensePreCondition_Type    specialDefensePreCondition_p;
...
//   RPG_Common_Attribute_Type                      attribute_p;
  ...
  rangedProperties_p.parsers(unsigned_byte_p,
                             unsigned_byte_p,
                             rangedEffectUnion_p);
  RPG_Character_Monster_DefenseAction_Type                 defenseAction_p;
  defenseAction_p.parsers(specialDefensePreCondition_p,
                          damage_p,
                          rangedProperties_p);
  RPG_Character_Monster_SpecialDefenseProperties_Type      specialDefenseProperties_p;
...
//   RPG_Character_Monster_NaturalWeapon_Type            naturalWeapon_p;
//   RPG_Character_Monster_WeaponTypeUnion_Type               weaponUnion_p;
...
//   ::xml_schema::boolean_pimpl                    bool_p;
  RPG_Character_Monster_AttackAction_Type                  attackAction_p;
  attackAction_p.parsers(weaponUnion_p,
                         ...
                         bool_p,
                         bool_p);
  RPG_Character_Monster_Attack_Type                        attack_p;
...
//   RPG_Common_Usage_Type                          usage_p;
  RPG_Character_Monster_ActionTrigger_Type                 trigger_p;
...
//   RPG_Combat_Check_Type                          check_p;
  RPG_Character_Monster_SpecialAttackPreCondition_Type     specialAttackPreCondition_p;
...
//   RPG_Character_Monster_AttackAction_Type                  attackAction_p;
//   RPG_Dice_Roll_Type                             roll_p;
  RPG_Character_Monster_SpecialAttackProperties_Type       specialAttack_p;
...
//                           roll_p,
  ...
  RPG_Character_Monster_SpecialAbilityPreCondition_Type    specialAbilityPreCondition_p;
  specialAbilityPreCondition_p.parsers(condition_p,
                                       size_p,
                                       check_p);
//   RPG_Dice_Roll_Type                             roll_p;
  ::xml_schema::float_pimpl                      float_p;
  RPG_Character_Monster_SummonMonster_Type                 summonMonster_p;
  summonMonster_p.parsers(string_p,
                          roll_p,
                          float_p,
                          bool_p);
//   RPG_Magic_SpellProperties_Type                 spellProperties_p;
  RPG_Character_Monster_SpecialAbilityProperties_Type      specialAbilityProperties_p;
...
//   unsigned_int_pimpl                      reach_p;
  RPG_Character_Monster_SavingThrowModifiers_Type          savingThrowModifiers_p;
  ...
  range_p.parsers(int_p,
                  int_p);
  RPG_Character_Monster_OrganizationSlaverStep_Type        organizationSlaverStep_p;
  organizationSlaverStep_p.parsers(string_p,
                                   range_p);
  RPG_Character_Monster_OrganizationStep_Type              organizationStep_p;
  organizationStep_p.parsers(organization_p,
                             range_p,
                             organizationSlaverStep_p);
  RPG_Character_Monster_Organizations_Type                 organizations_p;
...
//   RPG_Character_Alignment_Type                   alignment_p;
  ...
  RPG_Character_Monster_AdvancementStep_Type               advancementStep_p;
  advancementStep_p.parsers(size_p,
                            range_p);
  RPG_Character_Monster_Advancement_Type                   advancement_p;
  advancement_p.parsers(advancementStep_p);
//   unsigned_int_pimpl                      levelAdjustment_p;
  RPG_Character_Monster_PropertiesXML_Type                 propertiesXML_p;
  propertiesXML_p.parsers(string_p,
                          ...
                          advancement_p,
                          unsigned_byte_p);
  RPG_Character_Monster_Dictionary_Type                    dictionary_p(&myMonsterDictionary);
  ...
  catch (const ::xml_schema::parsing& exception)
  {
    ...
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Monster_Dictionary::initMonsterDictionary(): exception occurred: \"%s\", returning\n"),
               text.c_str()));
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Monster_Dictionary::initMonsterDictionary(): exception occurred, returning\n")));

    throw;
  }

  dictionary_p.post_RPG_Character_Monster_Dictionary_Type();
...
const RPG_Character_Monster_Properties
RPG_Character_Monster_Dictionary::getProperties(const std::string& name_in) const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::getProperties"));

  RPG_Character_Monster_DictionaryConstIterator_t iterator = myMonsterDictionary.find(name_in);
...
const unsigned long
RPG_Character_Monster_Dictionary::numEntries() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::numEntries"));

  return myMonsterDictionary.size();
}

void
RPG_Character_Monster_Dictionary::find(const RPG_Character_Alignment& alignment_in,
                             const RPG_Common_Environment& environment_in,
                             const RPG_Character_Monster_OrganizationSet_t& organizations_in,
                             RPG_Character_Monster_List_t& list_out) const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::find"));

  // init return value(s)
  list_out.clear();

  RPG_Character_Monster_OrganizationSet_t possible_organizations;
  for (RPG_Character_Monster_DictionaryConstIterator_t iterator = myMonsterDictionary.begin();
       ...
       iterator++)
  {
                                ...
                                iterator->second.environment))
    {
                                            ...
                                            iterator->second.alignment))
      {
        ...
        for (RPG_Character_Monster_OrganizationsIterator_t iterator2 = iterator->second.organizations.begin();
...
bool
RPG_Character_Monster_Dictionary::XSD_Error_Handler::handle(const std::string& id_in,
                                                  unsigned long line_in,
                                                  unsigned long column_in,
                                                  ::xsd::cxx::xml::error_handler<char>::severity severity_in,
                                                  const std::string& message_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::XSD_Error_Handler::handle"));
...
void
RPG_Character_Monster_Dictionary::dump() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster_Dictionary::dump"));
       ...
       iterator++)
  {
    ACE_DEBUG((LM_DEBUG,
               ...
               RPG_Character_Monster_Common_Tools::attackToString((iterator->second).attack).c_str(),
               ...
               RPG_Character_Monster_Common_Tools::advancementToString((iterator->second).advancements).c_str(),
