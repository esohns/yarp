...
RPG_Character_Monster::RPG_Character_Monster(// base attributes
...
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::RPG_Character_Monster"));
...
// RPG_Character_Monster::operator=(const RPG_Character_Monster& monster_in)
// {
//   RPG_TRACE(ACE_TEXT("RPG_Character_Monster::operator="));
//
//   myType = monster_in.myType;
//   myIsSummoned = monster_in.myIsSummoned;
...
RPG_Character_Monster::getType() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::getType"));

  return myType;
}

const bool
RPG_Character_Monster::isSummoned() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::isSummoned"));

  return myIsSummoned;
}

const signed char
RPG_Character_Monster::getArmorClass(const RPG_Combat_DefenseSituation& defenseSituation_in) const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::getArmorClass"));
  ...
  RPG_Character_Monster_Properties properties = RPG_CHARACTER_MONSTER_DICTIONARY_SINGLETON::instance()->getProperties(getName());
...
void
RPG_Character_Monster::gainExperience(const unsigned int& XP_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::gainExperience"));
...
const bool
RPG_Character_Monster::isPlayerCharacter() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::isPlayerCharacter"));

  return false;
}

void
RPG_Character_Monster::dump() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::dump"));

//   ACE_DEBUG((LM_DEBUG,
//              ACE_TEXT("Monster (type: \"%s\")\n"),
//              RPG_Character_Monster_Common_Tools::typeToString(myType).c_str()));

  inherited::dump();
}

const RPG_Character_BaseAttackBonus_t
RPG_Character_Monster::getAttackBonus(const RPG_Common_Attribute& modifier_in,
                            const RPG_Combat_AttackSituation& attackSituation_in) const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::getAttackBonus"));
...
const signed char
RPG_Character_Monster::getShieldBonus() const
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Monster::getShieldBonus"));
