...
#ifndef CXX__CHARACTER_MONSTER_ETC_RPG_MONSTER_XML_TREE_H
#define CXX__CHARACTER_MONSTER_ETC_RPG_MONSTER_XML_TREE_H
...
class RPG_Monster_SpecialPropertyTypeUnion_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Monster_SpecialPropertyTypeUnion_XMLTree_Type&) = default;
#endif
...
class RPG_Monster_SpecialBaseProperties_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  abilityClass (::std::unique_ptr< abilityClass_type > p);
  ...
  void
  actionType (::std::unique_ptr< actionType_type > p);
...
class RPG_Monster_NaturalWeapon_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Monster_NaturalWeapon_XMLTree_Type&) = default;
#endif
...
class RPG_Monster_WeaponTypeUnion_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Monster_WeaponTypeUnion_XMLTree_Type&) = default;
#endif
...
class RPG_Monster_DefenseAction_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  ranged (::std::unique_ptr< ranged_type > p);
...
class RPG_Monster_SpecialAttackPreCondition_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  targetAlignment (::std::unique_ptr< targetAlignment_type > p);
  ...
  void
  minTargetSize (::std::unique_ptr< minTargetSize_type > p);
  ...
  void
  maxTargetSize (::std::unique_ptr< maxTargetSize_type > p);
...
class RPG_Monster_Organization_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Monster_Organization_XMLTree_Type&) = default;
#endif
...
class RPG_Monster_PropertiesXML_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  hitDice (::std::unique_ptr< hitDice_type > p);
  ...
  void
  armorClass (::std::unique_ptr< armorClass_type > p);
  ...
  void
  saves (::std::unique_ptr< saves_type > p);
  ...
  void
  skills (::std::unique_ptr< skills_type > p);
  ...
  void
  feats (::std::unique_ptr< feats_type > p);
  ...
  void
  advancements (::std::unique_ptr< advancements_type > p);
  ...
  RPG_Monster_PropertiesXML_XMLTree_Type (const name_type&,
                                          ...
                                          ::std::unique_ptr< hitDice_type >,
                                          const initiative_type&,
                                          const speed_type&,
                                          ::std::unique_ptr< armorClass_type >,
                                          ::std::unique_ptr< attack_type >,
                                          const space_type&,
                                          const reach_type&,
                                          ::std::unique_ptr< saves_type >,
                                          ::std::unique_ptr< attributes_type >,
                                          ::std::unique_ptr< environment_type >,
                                          ::std::unique_ptr< organizations_type >,
                                          const challengeRating_type&,
                                          const treasureModifier_type&,
                                          ::std::unique_ptr< alignment_type >,
                                          const levelAdjustment_type&);
...
class RPG_Monster_StateBase_XMLTree_Type: public ::RPG_Player_StateBase_XMLTree_Type
{
  ...
  void
  inventory (::std::unique_ptr< inventory_type > p);
  ...
  RPG_Monster_StateBase_XMLTree_Type (::std::unique_ptr< conditions_type >,
                                      const HP_type&,
                                      const gold_type&,
                                      const maxHP_type&);
...
class RPG_Monster_State_XMLTree_Type: public ::RPG_Monster_StateBase_XMLTree_Type
{
  ...
  RPG_Monster_State_XMLTree_Type (::std::unique_ptr< conditions_type >,
                                  const HP_type&,
                                  const gold_type&,
                                  const maxHP_type&,
                                  const type_type&);
...
#endif // CXX__CHARACTER_MONSTER_ETC_RPG_MONSTER_XML_TREE_H
