...
void RPG_Character_ClassXML_XMLTree_Type::
metaClass (::std::unique_ptr< metaClass_type > x)
{
  this->metaClass_.set (std::move (x));
}
...
void RPG_Character_SkillValue_XMLTree_Type::
skill (::std::unique_ptr< skill_type > x)
{
  this->skill_.set (std::move (x));
}
...
void RPG_Character_Alignment_XMLTree_Type::
civic (::std::unique_ptr< civic_type > x)
{
  this->civic_.set (std::move (x));
}
...
void RPG_Character_Alignment_XMLTree_Type::
ethic (::std::unique_ptr< ethic_type > x)
{
  this->ethic_.set (std::move (x));
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< metaClass_type > r (
        metaClass_traits::create (i, f, this));

      if (!metaClass_.present ())
      {
        this->metaClass_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< skill_type > r (
        skill_traits::create (i, f, this));

      if (!skill_.present ())
      {
        this->skill_.set (::std::move (r));
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "skill" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->skill_.push_back (::std::move (r));
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< feat_type > r (
        feat_traits::create (i, f, this));

      this->feat_.push_back (::std::move (r));
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< civic_type > r (
        civic_traits::create (i, f, this));

      if (!civic_.present ())
      {
        this->civic_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< ethic_type > r (
        ethic_traits::create (i, f, this));

      if (!ethic_.present ())
      {
        this->ethic_.set (::std::move (r));
        continue;
      }
    }
...
operator<< (::xercesc::DOMElement& e, const RPG_Character_ClassXML_XMLTree_Type& i)
{
  ...
  for (RPG_Character_ClassXML_XMLTree_Type::subClass_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Character_ClassXML_XMLTree_Type::subClass_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Character_Skills_XMLTree_Type& i)
{
  ...
  for (RPG_Character_Skills_XMLTree_Type::skill_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Character_Skills_XMLTree_Type::skill_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Character_Feats_XMLTree_Type& i)
{
  ...
  for (RPG_Character_Feats_XMLTree_Type::feat_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Character_Feats_XMLTree_Type::feat_type& x (*b);
