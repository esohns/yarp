...
RPG_Character_CheckTypeUnion_XMLTree_Type::
RPG_Character_CheckTypeUnion_XMLTree_Type (const char* s)
: ::xml_schema::string (s)
{
}
...
RPG_Character_CheckTypeUnion_XMLTree_Type::
RPG_Character_CheckTypeUnion_XMLTree_Type (const RPG_Character_CheckTypeUnion_XMLTree_Type& o,
                                           ::xml_schema::flags f,
                                           ::xml_schema::container* c)
...
: ::xml_schema::type (),
  metaClass_ (metaClass, ::xml_schema::flags (), this),
  subClass_ (::xml_schema::flags (), this)
{
}
...
: ::xml_schema::type (),
  ...
  dexterity_ (dexterity, ::xml_schema::flags (), this),
  constitution_ (constitution, ::xml_schema::flags (), this),
  intelligence_ (intelligence, ::xml_schema::flags (), this),
  wisdom_ (wisdom, ::xml_schema::flags (), this),
  charisma_ (charisma, ::xml_schema::flags (), this)
{
}
...
: ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
  strength_ (f, this),
  dexterity_ (f, this),
  constitution_ (f, this),
  intelligence_ (f, this),
  wisdom_ (f, this),
  charisma_ (f, this)
{
  if ((f & ::xml_schema::flags::base) == 0)
...
: ::xml_schema::type (),
  skill_ (skill, ::xml_schema::flags (), this),
...
: ::xml_schema::type (),
  civic_ (civic, ::xml_schema::flags (), this),
  ethic_ (ethic, ::xml_schema::flags (), this)
{
}
...
{
  {
    ::std::auto_ptr< metaClass_type > r (new metaClass_type (s, f, this));
    this->metaClass_.set (r);
  }
...
{
  {
    ::std::auto_ptr< skill_type > r (new skill_type (s, f, this));
    this->skill_.set (r);
  }
...
{
  {
    ...
    if (n > 0)
    {
      ...
      while (n--)
      {
        ::std::auto_ptr< feat_type > r (new feat_type (s, f, this));
        c.push_back (r);
      }
    }
  }
...
{
  {
    ::std::auto_ptr< civic_type > r (new civic_type (s, f, this));
    this->civic_.set (r);
  }
