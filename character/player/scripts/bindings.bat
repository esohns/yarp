...
"E:\ACE_wrappers\bin\generate_export_file.pl" -n RPG_Player > .\..\rpg_character_player_exports.h

@rem C++ "glue code"
"E:\XML2CppCode\Debug\XML2CppCode.exe" -d RPG_Player_Export -e -f .\..\rpg_character_player.xsd -i -o .\.. -s -u -x RPG_Character_Player
