...
%XML2CppCodeEXE% -d RPG_Player_Export -e -f .\..\rpg_player.xsd -i -o .\.. -s -u -x RPG_Player
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-tree --export-symbol "RPG_Player_Export" --hxx-prologue "#include \"rpg_player_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\..\scripts\xsdcxx_tree_options --output-dir .\.. .\..\rpg_player.xsd
if %ERRORLEVEL% NEQ 0 (
