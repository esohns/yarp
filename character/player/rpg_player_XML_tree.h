...
#ifndef CXX__CHARACTER_PLAYER_ETC_RPG_PLAYER_XML_TREE_H
#define CXX__CHARACTER_PLAYER_ETC_RPG_PLAYER_XML_TREE_H
...
class RPG_Player_StateBase_XMLTree_Type;
...
class RPG_Player_CharacterBaseXML_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  abilities (::std::unique_ptr< abilities_type > p);
  ...
  void
  defaultSize (::std::unique_ptr< defaultSize_type > p);
  ...
  void
  knownSpells (::std::unique_ptr< knownSpells_type > p);
...
class RPG_Player_CharacterXML_XMLTree_Type: public ::RPG_Player_CharacterBaseXML_XMLTree_Type
{
  ...
  void
  classXML (::std::unique_ptr< classXML_type > p);
  ...
  void
  offhand (::std::unique_ptr< offhand_type > p);
...
class RPG_Player_StateBase_XMLTree_Type: public ::xml_schema::type
{
  ...
  // Constructors.
  //
  RPG_Player_StateBase_XMLTree_Type (const conditions_type&,
                                     const HP_type&);

  RPG_Player_StateBase_XMLTree_Type (::std::unique_ptr< conditions_type >,
                                     const HP_type&);
  ...
  virtual RPG_Player_StateBase_XMLTree_Type*
  _clone (::xml_schema::flags f = 0,
          ::xml_schema::container* c = 0) const;
...
class RPG_Player_State_XMLTree_Type: public ::RPG_Player_StateBase_XMLTree_Type
{
  ...
  // Constructors.
  //
  RPG_Player_State_XMLTree_Type (const conditions_type&,
                                 const HP_type&,
                                 const file_type&);

  RPG_Player_State_XMLTree_Type (::std::unique_ptr< conditions_type >,
                                 const HP_type&,
                                 const file_type&);
...
#endif // CXX__CHARACTER_PLAYER_ETC_RPG_PLAYER_XML_TREE_H
