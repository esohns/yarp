...
RPG_Character_Player_Common_Tools::raceXMLTreeToRace(const RPG_Character_PlayerXML_XMLTree_Type::race_sequence& races_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::raceXMLTreeToRace"));
...
RPG_Character_Player_Common_Tools::spellsXMLTreeToSpellTypes(const RPG_Character_Spells_XMLTree_Type& spells_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::spellsXMLTreeToSpellTypes"));

  RPG_Magic_SpellTypes_t result;

  for (RPG_Character_Spells_XMLTree_Type::spell_const_iterator iterator = spells_in.spell().begin();
...
RPG_Character_Player_Common_Tools::conditionsXMLTreeToConditions(const RPG_Character_Conditions_XMLTree_Type& conditions_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::conditionsXMLTreeToConditions"));

  RPG_Character_Conditions_t result;

  for (RPG_Character_Conditions_XMLTree_Type::condition_const_iterator iterator = conditions_in.condition().begin();
...
RPG_Magic_Spells_t
RPG_Character_Player_Common_Tools::spellsXMLTreeToSpells(const RPG_Character_Spells_XMLTree_Type& spells_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::spellsXMLTreeToSpells"));
...
RPG_Character_Player_Common_Tools::generatePlayerCharacter()
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::generatePlayerCharacter"));
...
//       }
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::generatePlayerCharacter(): caught exception: \"%s\", continuing\n"),
               exception.what()));
  }
  ...
  try
  {
    player_p = new RPG_Character_Player(name,
                                        gender,
                                        player_race,
                                        player_class,
                                        alignment,
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::generatePlayerCharacter(): exception occurred: \"%s\", aborting\n"),
               exception.what()));
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::generatePlayerCharacter(): exception occurred, aborting\n")));
...
const unsigned int
RPG_Character_Player_Common_Tools::restParty(RPG_Character_Party_t& party_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::restParty"));
...
RPG_Character_Player*
RPG_Character_Player_Common_Tools::playerXMLToPlayer(const RPG_Character_PlayerXML_XMLTree_Type& player_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::playerXMLToPlayer"));
  ...
  if (player_in.skills().present())
    skills = RPG_Character_Player_Common_Tools::skillsXMLTreeToSkills(player_in.skills().get());
  RPG_Character_Feats_t feats;
  if (player_in.feats().present())
    feats = RPG_Character_Player_Common_Tools::featsXMLTreeToFeats(player_in.feats().get());
  RPG_Character_Abilities_t abilities;
  if (player_in.abilities().present())
    abilities = RPG_Character_Player_Common_Tools::abilitiesXMLTreeToAbilities(player_in.abilities().get());
  RPG_Magic_SpellTypes_t known_spells;
  if (player_in.knownSpells().present())
    known_spells = RPG_Character_Player_Common_Tools::spellsXMLTreeToSpellTypes(player_in.knownSpells().get());
  RPG_Magic_Spells_t spells;
  if (player_in.spells().present())
    spells = RPG_Character_Player_Common_Tools::spellsXMLTreeToSpells(player_in.spells().get());

  RPG_Character_Player* player_p = NULL;
  try
  {
    player_p = new RPG_Character_Player(player_in.name(),
                                        RPG_Character_GenderHelper::stringToRPG_Character_Gender(player_in.gender()),
                                        RPG_Character_Player_Common_Tools::raceXMLTreeToRace(player_in.race()),
                                        ...
                                        player_in.maxHP(),
                                        known_spells,
                                        RPG_Character_Player_Common_Tools::conditionsXMLTreeToConditions(player_in.conditions()),
                                        player_in.HP(),
                                        player_in.XP(),
                                        player_in.gold(),
                                        spells,
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::playerXMLToPlayer(): exception occurred: \"%s\", aborting\n"),
               exception.what()));
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::playerXMLToPlayer(): exception occurred, aborting\n")));
...
RPG_Character_PlayerXML_XMLTree_Type* RPG_Character_Player_Common_Tools::playerToPlayerXML(const RPG_Character_Player& player_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Character_Player_Common_Tools::playerToPlayerXML"));
  ...
  RPG_Character_Conditions_XMLTree_Type conditions;
  ...
  RPG_Character_Inventory character_inventory = player_in.getInventory();
  ...
  RPG_Character_PlayerXML_XMLTree_Type* player_p = NULL;
  try
  {
    player_p = new RPG_Character_PlayerXML_XMLTree_Type(player_in.getName(),
                                                        alignment,
                                                        attributes,
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::playerToPlayerXML(): exception occurred: \"%s\", aborting\n"),
               exception.what()));
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Character_Player_Common_Tools::playerToPlayerXML(): exception occurred, aborting\n")));
  ...
  RPG_Character_Spells_XMLTree_Type spell_list;
