...
RPG_Player_StateBase_XMLTree_Type::
RPG_Player_StateBase_XMLTree_Type (::std::auto_ptr< conditions_type > conditions,
                                   const HP_type& HP)
: ::xml_schema::type (),
  conditions_ (conditions, this),
  HP_ (HP, this)
...
RPG_Player_State_XMLTree_Type::
RPG_Player_State_XMLTree_Type (::std::auto_ptr< conditions_type > conditions,
                               const HP_type& HP,
                               const file_type& file)
: ::RPG_Player_StateBase_XMLTree_Type (conditions,
                                       HP),
          ...
          const ::xml_schema::properties& p)
{
  ...
  return ::std::auto_ptr< ::RPG_Player_PlayerXML_XMLTree_Type > (
    ::player_t (
       ...
       ::xml_schema::flags f)
{
  XSD_UNUSED (f);
  {
    ...
    if (n > 0)
    {
      ...
      {
        ::std::auto_ptr< ability_type > r (
          ability_traits::create (s, f, this));
        c.push_back (r);
      }
    }
  }
       ...
       ::xml_schema::flags f)
{
  XSD_UNUSED (f);
  {
    ...
    if (n > 0)
    {
      ...
      {
        ::std::auto_ptr< condition_type > r (
          condition_traits::create (s, f, this));
        c.push_back (r);
      }
    }
  }
       ...
       ::xml_schema::flags f)
{
...

  {
    ...
    {
      ::std::auto_ptr< abilities_type > r (
        abilities_traits::create (s, f, this));
      this->abilities_.set (r);
    }
  }
  ...
  {
    ::std::auto_ptr< alignment_type > r (
      alignment_traits::create (s, f, this));
    this->alignment_.set (r);
  }

  {
    ::std::auto_ptr< attributes_type > r (
      attributes_traits::create (s, f, this));
    this->attributes_.set (r);
  }

  {
    ::std::auto_ptr< defaultSize_type > r (
      defaultSize_traits::create (s, f, this));
    this->defaultSize_.set (r);
  }
...

  {
    ...
    {
      ::std::auto_ptr< knownSpells_type > r (
        knownSpells_traits::create (s, f, this));
      this->knownSpells_.set (r);
    }
  }
       ...
       ::xml_schema::flags f)
{
  ...
  {
    ::std::auto_ptr< classXML_type > r (
      classXML_traits::create (s, f, this));
    this->classXML_.set (r);
  }

  {
    ::std::auto_ptr< gender_type > r (
      gender_traits::create (s, f, this));
    this->gender_.set (r);
  }

  {
    ::std::auto_ptr< offhand_type > r (
      offhand_traits::create (s, f, this));
    this->offhand_.set (r);
  }
       ...
       ::xml_schema::flags f)
{
  ...
  {
    ::std::auto_ptr< inventory_type > r (
      inventory_traits::create (s, f, this));
    this->inventory_.set (r);
  }
       ...
       ::xml_schema::flags f)
{
  ...
  {
    ::std::auto_ptr< conditions_type > r (
      conditions_traits::create (s, f, this));
    this->conditions_.set (r);
  }
