...
if (SDL_SUPPORT)
 ...
 elseif (SDL1_FOUND)
  ...
  set (SUPPORTED_SDL_VERSIONS "SDL1")
 endif ()
 if (SDL1_FOUND)
  set (SUPPORTED_SDL_VERSIONS "${SUPPORTED_SDL_VERSIONS};SDL1")
 endif (SDL1_FOUND)
 if (SDL2_FOUND)
 ...
 if (${SDL_VERSION} STREQUAL "SDL1")
  message (STATUS "using SDL1")
  set (SDL1_USE ON CACHE STRING "use SDL1")
  mark_as_advanced (FORCE SDL1_USE)
  add_definitions (-DSDL1_USE)
...
if (SDL_SUPPORT AND NOT SDL1_USE AND NOT SDL2_USE AND NOT SDL3_USE)
...
endif (SDL_SUPPORT AND NOT SDL1_USE AND NOT SDL2_USE AND NOT SDL3_USE)
