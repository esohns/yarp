...
#ifndef RPG_CLIENT_WINDOW_LEVEL_STUB_H
#define RPG_CLIENT_WINDOW_LEVEL_STUB_H
...
class RPG_Client_Window_Level_Stub
 ...
 , public RPG_Client_IWindowLevel
{
 ...
 public:
  RPG_Client_Window_Level_Stub (// *** SDL window ***
                                const RPG_Graphics_SDLWindowBase&); // parent
  virtual ~RPG_Client_Window_Level_Stub ();
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (RPG_Client_Window_Level_Stub ())
  ACE_UNIMPLEMENTED_FUNC (RPG_Client_Window_Level_Stub (const RPG_Client_Window_Level_Stub&))
  ACE_UNIMPLEMENTED_FUNC (RPG_Client_Window_Level_Stub& operator= (const RPG_Client_Window_Level_Stub&))
