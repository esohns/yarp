...
"%XsdEXE%" cxx-tree --output-dir .\.. --root-element-all --export-symbol "RPG_Client_Export" --hxx-prologue "#include \"rpg_client_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\scripts\xsdcxx_tree_options ..\rpg_client.xsd
if %ERRORLEVEL% NEQ 0 (
