...
enum RPG_Engine_Command
{
  ...
  COMMAND_E2C_ENTITY_HIT, // play sound
  COMMAND_E2C_ENTITY_MISS, // play sound
  COMMAND_E2C_ENTITY_CONDITION, // play sound(, leave game)
  COMMAND_E2C_ENTITY_POSITION, // update UI
  COMMAND_E2C_ENTITY_VISION, // update UI
  COMMAND_E2C_ENTITY_LEVEL_UP, // play sound, level up
  COMMAND_E2C_ENTITY_STATE, // player stats have changed (XP gained, HP lost, etc) --> update UI
  COMMAND_E2C_INIT,
  COMMAND_E2C_MESSAGE,
  COMMAND_E2C_QUIT,
  //
