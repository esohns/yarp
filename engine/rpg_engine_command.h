...
class RPG_Engine_Export RPG_Engine_CommandHelper
{
 public:
  inline static void init()
  {
    ...
    myRPG_Engine_CommandToStringTable.insert(std::make_pair(COMMAND_E2C_ENTITY_POSITION_UPDATE, ACE_TEXT_ALWAYS_CHAR("COMMAND_E2C_ENTITY_POSITION_UPDATE")));
    myRPG_Engine_CommandToStringTable.insert(std::make_pair(COMMAND_E2C_ENTITY_VISION_UPDATE, ACE_TEXT_ALWAYS_CHAR("COMMAND_E2C_ENTITY_VISION_UPDATE")));
