...
#ifndef CXX__ENGINE_ETC_RPG_ENGINE_XML_TREE_H
#define CXX__ENGINE_ETC_RPG_ENGINE_XML_TREE_H
...
class RPG_Engine_Command_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Engine_Command_XMLTree_Type&) = default;
#endif
  ...
  public:
  static const char* const _xsd_RPG_Engine_Command_XMLTree_Type_literals_[23];
  static const value _xsd_RPG_Engine_Command_XMLTree_Type_indexes_[23];
};
...
class RPG_Engine_EntityMode_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Engine_EntityMode_XMLTree_Type&) = default;
#endif
...
class RPG_Engine_EntityState_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  monster (::std::unique_ptr< monster_type > p);
  ...
  RPG_Engine_EntityState_XMLTree_Type (::std::unique_ptr< position_type >);
...
#endif // CXX__ENGINE_ETC_RPG_ENGINE_XML_TREE_H
