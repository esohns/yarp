...
#include "../character/player/rpg_character_player_XML_tree.h"
...
class RPG_Engine_Export RPG_Engine_Player_XMLTree_Type: public ::RPG_Character_PlayerXML_XMLTree_Type
{
  public:
  // position
  // 
