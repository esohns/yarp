...
void RPG_Engine_EntityState_XMLTree_Type::
monster (::std::unique_ptr< monster_type > x)
{
  this->monster_.set (std::move (x));
}
...
_xsd_RPG_Engine_Command_XMLTree_Type_convert () const
{
  ...
  const value* i (::std::lower_bound (
                    ...
                    _xsd_RPG_Engine_Command_XMLTree_Type_indexes_ + 23,
                    *this,
                    c));

  if (i == _xsd_RPG_Engine_Command_XMLTree_Type_indexes_ + 23 || _xsd_RPG_Engine_Command_XMLTree_Type_literals_[*i] != *this)
  {
...
_xsd_RPG_Engine_Command_XMLTree_Type_literals_[23] =
{
  "COMMAND_ATTACK",
  "COMMAND_ATTACK_FULL",
...
_xsd_RPG_Engine_Command_XMLTree_Type_indexes_[23] =
{
  ...
  ::RPG_Engine_Command_XMLTree_Type::COMMAND_E2C_ENTITY_STATE,
...
RPG_Engine_EntityState_XMLTree_Type::
RPG_Engine_EntityState_XMLTree_Type (::std::unique_ptr< position_type > position)
: ::xml_schema::type (),
  player_ (this),
  monster_ (this),
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "mode" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->mode_.push_back (::std::move (r));
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  ...
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< spawn_type > r (
        spawn_traits::create (i, f, this));

      this->spawn_.push_back (::std::move (r));
      continue;
    }
...
operator= (const RPG_Engine_Level_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Map_Level_XMLTree_Type& > (*this) = x;
    this->spawn_ = x.spawn_;
...
operator= (const RPG_Engine_State_XMLTree_Type& x)
{
  if (this != &x)
  {
    static_cast< ::RPG_Map_State_XMLTree_Type& > (*this) = x;
...
::std::unique_ptr< ::RPG_Engine_Level_XMLTree_Type >
                ...
                const ::xml_schema::properties& p)
{
  ...
  return ::std::unique_ptr< ::RPG_Engine_Level_XMLTree_Type > (
    ::engine_level_t (
...
::std::unique_ptr< ::RPG_Engine_Level_XMLTree_Type >
engine_level_t (const ::xercesc::DOMDocument& doc,
                ::xml_schema::flags f,
                const ::xml_schema::properties& p)
{
  ...
  {
    ::std::unique_ptr< ::RPG_Engine_Level_XMLTree_Type > r (
...
::std::unique_ptr< ::RPG_Engine_Level_XMLTree_Type >
engine_level_t (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
                ::xml_schema::flags f,
...
::std::unique_ptr< ::RPG_Engine_State_XMLTree_Type >
                ...
                const ::xml_schema::properties& p)
{
  ...
  return ::std::unique_ptr< ::RPG_Engine_State_XMLTree_Type > (
    ::engine_state_t (
      std::move (d), f | ::xml_schema::flags::own_dom, p));
}
...
::std::unique_ptr< ::RPG_Engine_State_XMLTree_Type >
engine_state_t (const ::xercesc::DOMDocument& doc,
                ::xml_schema::flags f,
                const ::xml_schema::properties& p)
{
  if (f & ::xml_schema::flags::keep_dom)
  ...
  if (n.name () == "engine_state_t" &&
      n.namespace_ () == "urn:rpg")
  {
    ::std::unique_ptr< ::RPG_Engine_State_XMLTree_Type > r (
...
::std::unique_ptr< ::RPG_Engine_State_XMLTree_Type >
engine_state_t (::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > d,
                ::xml_schema::flags f,
                const ::xml_schema::properties&)
{
  ::xml_schema::dom::unique_ptr< ::xercesc::DOMDocument > c (
...
operator<< (::xercesc::DOMElement& e, const RPG_Engine_EntityState_XMLTree_Type& i)
{
  ...
  for (RPG_Engine_EntityState_XMLTree_Type::mode_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Engine_EntityState_XMLTree_Type::mode_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Engine_Level_XMLTree_Type& i)
{
  ...
  for (RPG_Engine_Level_XMLTree_Type::spawn_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Engine_Level_XMLTree_Type::spawn_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Engine_State_XMLTree_Type& i)
{
  ...
  for (RPG_Engine_State_XMLTree_Type::entities_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Engine_State_XMLTree_Type::entities_type& x (*b);
