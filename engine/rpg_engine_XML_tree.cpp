                ...
                const ::xml_schema::properties& p)
{
  ...
  return ::std::auto_ptr< ::RPG_Engine_Level_XMLTree_Type > (
    ::engine_level_t (
                ...
                const ::xml_schema::properties& p)
{
  ...
  return ::std::auto_ptr< ::RPG_Engine_State_XMLTree_Type > (
    ::engine_state_t (
      d, f | ::xml_schema::flags::own_dom, p));
}
...
RPG_Engine_Command_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                 ...
                                 ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Engine_Command_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Engine_Command_XMLTree_Type_convert ();
}
...
RPG_Engine_EntityMode_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                    ...
                                    ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Engine_EntityMode_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Engine_EntityMode_XMLTree_Type_convert ();
}
       ...
       ::xml_schema::flags f)
{
  ...
  {
    ::std::auto_ptr< position_type > r (
      position_traits::create (s, f, this));
    this->position_.set (r);
  }
       ...
       ::xml_schema::flags f)
{
  XSD_UNUSED (f);
  {
    ...
    if (n > 0)
    {
      ...
      {
        ::std::auto_ptr< entities_type > r (
          entities_traits::create (s, f, this));
        c.push_back (r);
      }
    }
  }
...
{
  RPG_Engine_Command_XMLTree_Type::value v (x);
...
{
  RPG_Engine_EntityMode_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
