...
#define RPG_ENGINE_LEVEL_STYLE_DEF_DOORSTYLE         DOORSTYLE_WOOD
#define RPG_ENGINE_LEVEL_STYLE_DEF_EDGESTYLE         EDGESTYLE_FLOOR_STONE_COBBLED
#define RPG_ENGINE_LEVEL_STYLE_DEF_FLOORSTYLE        FLOORSTYLE_STONE_COBBLED
#define RPG_ENGINE_LEVEL_STYLE_HALFHEIGHTWALLS       false
#define RPG_ENGINE_LEVEL_STYLE_DEF_WALLSTYLE         WALLSTYLE_BRICK
