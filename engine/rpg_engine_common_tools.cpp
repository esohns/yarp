...
void
RPG_Engine_Common_Tools::createLevel(const RPG_Engine_LevelMeta_t& metaData_in,
                                     const std::string& name_in,
                                     const RPG_Map_FloorPlan_Config_t& mapConfig_in,
                                     RPG_Engine_Level_t& level_out)
{
  RPG_TRACE(ACE_TEXT("RPG_Engine_Common_Tools::createLevel"));

  level_out.level_meta = metaData_in;
...
RPG_Engine_Level_t
RPG_Engine_Common_Tools::loadLevel(const std::string& filename_in,
                                   const std::string& schemaRepository_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Engine_Common_Tools::loadLevel"));

  RPG_Engine_Level_t result;
  result.level_meta.monsters.clear();
  result.level_meta.probability = 0.0F;
  result.level_meta.spawn_interval = ACE_Time_Value::zero;
  result.map.name.clear();
...
//   props.schema_location("http://www.w3.org/XML/1998/namespace", "xml.xsd");
  ...
  result = RPG_Engine_Common_Tools::levelXMLToLevel(*level_p);

  return result;
}

bool
RPG_Engine_Common_Tools::saveLevel(const RPG_Engine_Level_t& level_in,
                                   const std::string& filename_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Engine_Common_Tools::saveLevel"));
...
//     } // end IF
  ...
  RPG_Engine_Level_XMLTree_Type* level_xml_p = RPG_Engine_Common_Tools::levelToLevelXML(level_in);
...
void
RPG_Engine_Common_Tools::dump(const RPG_Engine_Level_t& level_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Engine_Common_Tools::dump"));

  RPG_Map_Common_Tools::dump(level_in.map);

  std::cout << ACE_TEXT_ALWAYS_CHAR("roaming monsters:") << std::endl;
  ...
  std::cout << ACE_TEXT_ALWAYS_CHAR("spawn interval (sec,usec): ")
            << level_in.level_meta.spawn_interval.sec()
            << level_in.level_meta.spawn_interval.usec()
            << std::endl;
  std::cout << ACE_TEXT_ALWAYS_CHAR("spawn probability (%): ")
            << level_in.level_meta.probability << std::endl;
}
...
RPG_Engine_Common_Tools::levelToLevelXML(const RPG_Engine_Level_t& level_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Engine_Common_Tools::levelToLevelXML"));

  RPG_Common_FixedPeriod_XMLTree_Type spawn_interval(static_cast<unsigned int>(level_in.level_meta.spawn_interval.sec()),
                                                     static_cast<unsigned int>(level_in.level_meta.spawn_interval.usec()));
  std::string map_string = RPG_Map_Common_Tools::map2String(level_in.map);

  RPG_Engine_Level_XMLTree_Type* level_p = NULL;
  try
  {
    level_p = new RPG_Engine_Level_XMLTree_Type(spawn_interval,
  ...
  {
    ACE_DEBUG((LM_ERROR,
               ACE_TEXT("RPG_Engine_Common_Tools::levelToLevelXML(): exception occurred: \"%s\", aborting\n"),
               exception.what()));
...
RPG_Engine_Level_t
RPG_Engine_Common_Tools::levelXMLToLevel(const RPG_Engine_Level_XMLTree_Type& level_in)
{
  RPG_TRACE(ACE_TEXT("RPG_Engine_Common_Tools::levelXMLToLevel"));
  ...
  parser_driver.init(&result.map.name,
                     &result.map.start,
                     &result.map.seeds,
                     &result.map.plan,
                     false, false);
