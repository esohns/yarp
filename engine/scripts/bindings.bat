...
%XML2CppCodeEXE% -e -f .\..\rpg_engine.xsd -i -o .\.. -s -u -x RPG_Engine
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-tree --output-dir .\.. --root-element-all --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\scripts\xsdcxx_tree_options ..\rpg_engine.xsd
if %ERRORLEVEL% NEQ 0 (
