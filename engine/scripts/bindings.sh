...
perl /usr/lib/ace/bin/generate_export_file.pl -n RPG_Engine > ./../rpg_engine_exports.h

# C++ "glue code"
XML2CppCode -e -f ./../rpg_engine.xsd -i -o ./.. -s -u
