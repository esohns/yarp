...
: ::xml_schema::type (),
  maxRange_ (maxRange, ::xml_schema::flags (), this),
...
RPG_Combat_DamageDuration_XMLTree_Type ()
: ::xml_schema::type (),
  incubationPeriod_ (::xml_schema::flags (), this),
  totalPeriod_ (::xml_schema::flags (), this),
  interval_ (::xml_schema::flags (), this),
  totalDuration_ (::xml_schema::flags (), this),
  vicinity_ (vicinity_default_value (), ::xml_schema::flags (), this)
{
}
...
RPG_Combat_DamageDuration_XMLTree_Type (const ::xercesc::DOMElement& e,
                                        ...
                                        ::xml_schema::container* c)
: ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
  incubationPeriod_ (f, this),
  totalPeriod_ (f, this),
  interval_ (f, this),
  totalDuration_ (f, this),
  vicinity_ (f, this)
{
  if ((f & ::xml_schema::flags::base) == 0)
  {
...
: ::xml_schema::type (),
  ...
  secondary_ (::xml_schema::flags (), this),
  attribute_ (::xml_schema::flags (), this),
  condition_ (::xml_schema::flags (), this),
  duration_ (::xml_schema::flags (), this),
  counterMeasure_ (::xml_schema::flags (), this),
  other_ (::xml_schema::flags (), this),
  effect_ (effect_default_value (), ::xml_schema::flags (), this)
{
}
...
: ::xml_schema::type (),
  ...
  elementsAreInclusive_ (elementsAreInclusive_default_value (), ::xml_schema::flags (), this)
{
}
...
{
  {
    ...
    if (p)
    {
      ::std::auto_ptr< incubationPeriod_type > r (new incubationPeriod_type (s, f, this));
      this->incubationPeriod_.set (r);
    }
  }

  {
    ...
    if (p)
    {
      ::std::auto_ptr< totalPeriod_type > r (new totalPeriod_type (s, f, this));
      this->totalPeriod_.set (r);
    }
  }
       ...
       ::xml_schema::flags f)
{
...

  {
    ...
    if (p)
    {
      ::std::auto_ptr< secondary_type > r (new secondary_type (s, f, this));
      this->secondary_.set (r);
    }
  }
...

  {
    ...
    if (n > 0)
    {
      ...
      while (n--)
      {
        ::std::auto_ptr< other_type > r (new other_type (s, f, this));
        c.push_back (r);
      }
    }
  }
