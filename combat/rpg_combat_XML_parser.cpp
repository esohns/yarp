...
RPG_Combat_AttackForm
RPG_Combat_AttackForm_Type::post_RPG_Combat_AttackForm_Type ()
{
...
void
RPG_Combat_RangedEffectUnion_Type::_characters (const ::xml_schema::ro_string& effectType_in)
{
...
RPG_Combat_RangedEffectUnion
RPG_Combat_RangedEffectUnion_Type::post_RPG_Combat_RangedEffectUnion_Type ()
{
  RPG_TRACE (ACE_TEXT ("RPG_Combat_RangedEffectUnion_Type::post_RPG_Combat_RangedEffectUnion_Type"));

  struct RPG_Combat_RangedEffectUnion result = myCurrentRangedEffect;
...
void
RPG_Combat_RangedAttackProperties_Type::maxRange (unsigned char maxRange_in)
{
...
void
RPG_Combat_RangedAttackProperties_Type::increment (unsigned char increment_in)
{
...
void
RPG_Combat_RangedAttackProperties_Type::effect (const RPG_Combat_RangedEffectUnion& effect_in)
{
...
RPG_Combat_RangedAttackProperties
RPG_Combat_RangedAttackProperties_Type::post_RPG_Combat_RangedAttackProperties_Type ()
{
...
RPG_Combat_AttackSituation
RPG_Combat_AttackSituation_Type::post_RPG_Combat_AttackSituation_Type ()
{
...
RPG_Combat_DefenseSituation
RPG_Combat_DefenseSituation_Type::post_RPG_Combat_DefenseSituation_Type ()
{
...
RPG_Combat_SpecialAttack
RPG_Combat_SpecialAttack_Type::post_RPG_Combat_SpecialAttack_Type ()
{
...
RPG_Combat_SpecialDamageType
RPG_Combat_SpecialDamageType_Type::post_RPG_Combat_SpecialDamageType_Type ()
{
...
void
RPG_Combat_DamageTypeUnion_Type::_characters (const ::xml_schema::ro_string& damageType_in)
{
...
RPG_Combat_DamageTypeUnion
RPG_Combat_DamageTypeUnion_Type::post_RPG_Combat_DamageTypeUnion_Type ()
{
...
void
RPG_Combat_DamageDuration_Type::incubationPeriod (const RPG_Dice_Roll& incubationPeriod_in)
{
...
void
RPG_Combat_DamageDuration_Type::totalPeriod (const RPG_Dice_Roll& totalPeriod_in)
{
...
void
RPG_Combat_DamageDuration_Type::interval (unsigned short interval_in)
{
...
void
RPG_Combat_DamageDuration_Type::totalDuration (unsigned short duration_in)
{
...
void 
RPG_Combat_DamageDuration_Type::vicinity (bool vicinity_in)
{
...
RPG_Combat_DamageDuration
RPG_Combat_DamageDuration_Type::post_RPG_Combat_DamageDuration_Type ()
{
...
RPG_Combat_OtherDamageType
RPG_Combat_OtherDamageType_Type::post_RPG_Combat_OtherDamageType_Type ()
{
...
void
RPG_Combat_OtherDamage_Type::type (const RPG_Combat_OtherDamageType& type_in)
{
...
void
RPG_Combat_OtherDamage_Type::modifier (signed char modifier_in)
{
...
void
RPG_Combat_OtherDamage_Type::counterMeasure (const RPG_Combat_DamageCounterMeasure& counterMeasure_in)
{
...
RPG_Combat_OtherDamage
RPG_Combat_OtherDamage_Type::post_RPG_Combat_OtherDamage_Type ()
{
...
void
RPG_Combat_CheckTypeUnion_Type::_characters (const ::xml_schema::ro_string& checkType_in)
{
...
RPG_Combat_CheckTypeUnion
RPG_Combat_CheckTypeUnion_Type::post_RPG_Combat_CheckTypeUnion_Type()
{
...
void
RPG_Combat_Check_Type::type(const RPG_Combat_CheckTypeUnion& checkUnion_in)
{
...
void
RPG_Combat_Check_Type::attribute (const RPG_Common_Attribute& attribute_in)
{
...
void
RPG_Combat_Check_Type::difficultyClass (unsigned char difficultyClass_in)
{
...
RPG_Combat_Check
RPG_Combat_Check_Type::post_RPG_Combat_Check_Type ()
{
...
RPG_Combat_DamageReductionType
RPG_Combat_DamageReductionType_Type::post_RPG_Combat_DamageReductionType_Type ()
{
...
void
RPG_Combat_DamageCounterMeasure_Type::type (const RPG_Common_CounterMeasure& type_in)
{
...
void
RPG_Combat_DamageCounterMeasure_Type::check (const RPG_Combat_Check& check_in)
{
...
void
RPG_Combat_DamageCounterMeasure_Type::spell (const RPG_Magic_SpellType& spell_in)
{
...
void
RPG_Combat_DamageCounterMeasure_Type::duration (const RPG_Common_Duration& duration_in)
{
...
void
RPG_Combat_DamageCounterMeasure_Type::condition (const RPG_Common_Condition& condition_in)
{
...
void
RPG_Combat_DamageCounterMeasure_Type::reduction (const RPG_Combat_DamageReductionType& reduction_in)
{
...
RPG_Combat_DamageCounterMeasure
RPG_Combat_DamageCounterMeasure_Type::post_RPG_Combat_DamageCounterMeasure_Type()
{
...
void
RPG_Combat_DamageElement_Type::type (const RPG_Combat_DamageTypeUnion& damageType_in)
{
...
void
RPG_Combat_DamageElement_Type::amount (const RPG_Dice_Roll& amount_in)
{
...
void
RPG_Combat_DamageElement_Type::secondary (const RPG_Dice_Roll& secondary_in)
{
...
void
RPG_Combat_DamageElement_Type::condition (const RPG_Common_Condition& condition_in)
{
...
void
RPG_Combat_DamageElement_Type::duration (const RPG_Combat_DamageDuration& duration_in)
{
...
void
RPG_Combat_DamageElement_Type::other (const RPG_Combat_OtherDamage& bonus_in)
{
...
void
RPG_Combat_DamageElement_Type::attribute(const RPG_Common_Attribute& attitude_in)
{
...
void
RPG_Combat_DamageElement_Type::counterMeasure (const RPG_Combat_DamageCounterMeasure& counterMeasure_in)
{
...
void
RPG_Combat_DamageElement_Type::effect (const RPG_Common_EffectType& effect_in)
{
...
RPG_Combat_DamageElement
RPG_Combat_DamageElement_Type::post_RPG_Combat_DamageElement_Type ()
{
...
void
RPG_Combat_Damage_Type::element (const RPG_Combat_DamageElement& element_in)
{
...
void
RPG_Combat_Damage_Type::elementsAreInclusive (bool elementsAreInclusive_in)
{
...
RPG_Combat_Damage
RPG_Combat_Damage_Type::post_RPG_Combat_Damage_Type ()
{
