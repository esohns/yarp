...
# C++ "glue code"
XML2CppCode -e -f ./combat/rpg_combat.xsd -i -o ./combat -s -u -x RPG_Combat
...
xsdcxx cxx-parser --type-map ./combat/rpg_combat.map --char-type char --output-dir ./combat --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc ./combat/rpg_combat.xsd
[ $? -ne 0 ] && echo "ERROR: failed to xsdcxx, aborting" && exit 1
