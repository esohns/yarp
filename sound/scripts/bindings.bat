...
C:\Perl\bin\perl.exe C:\Temp\ACE_wrappers\bin\generate_export_file.pl -n RPG_Sound > .\..\rpg_sound_exports.h

@rem C++ "glue code"
C:\Tools\XML2CppCode.exe -d RPG_Sound_Export -e -f .\..\rpg_sound.xsd -i -o .\.. -s -u -x RPG_Sound
