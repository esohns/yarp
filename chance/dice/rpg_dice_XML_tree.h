...
#ifndef CXX__CHANCE_DICE_ETC_RPG_DICE_XML_TREE_H
#define CXX__CHANCE_DICE_ETC_RPG_DICE_XML_TREE_H
...
class RPG_Dice_DieType_XMLTree_Type: public ::xml_schema::string
{
  ...
  operator= (const RPG_Dice_DieType_XMLTree_Type&) = default;
#endif
...
class RPG_Dice_Roll_XMLTree_Type: public ::xml_schema::type
{
  ...
  void
  typeDice (::std::unique_ptr< typeDice_type > p);
...
#endif // CXX__CHANCE_DICE_ETC_RPG_DICE_XML_TREE_H
