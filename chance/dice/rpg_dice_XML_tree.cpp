...
operator= (const RPG_Dice_Roll_XMLTree_Type& x)
{
  if (this != &x)
  {
    ...
    this->numDice_ = x.numDice_;
    this->typeDice_ = x.typeDice_;
...
RPG_Dice_DieType_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                               ...
                               ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Dice_DieType_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Dice_DieType_XMLTree_Type_convert ();
}
       ...
       ::xml_schema::flags f)
{
  ...
  {
    ::std::auto_ptr< typeDice_type > r (
      typeDice_traits::create (s, f, this));
    this->typeDice_.set (r);
  }
...
{
  RPG_Dice_DieType_XMLTree_Type::value v (x);
