...
%XML2CppCodeEXE% -d RPG_Dice_Export -e -f .\..\rpg_dice.xsd -i -o .\.. -s -u -x RPG_Dice
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-parser --type-map .\..\rpg_dice.map --output-dir .\.. --export-symbol "RPG_Dice_Export" --hxx-prologue "#include \"rpg_dice_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\..\scripts\xsdcxx_parser_options .\..\rpg_dice.xsd
if %ERRORLEVEL% NEQ 0 (
...
"%XsdEXE%" cxx-tree --output-dir .\.. --export-symbol "RPG_Dice_Export" --hxx-prologue "#include \"rpg_dice_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp --options-file .\..\..\..\scripts\xsdcxx_tree_options .\..\rpg_dice.xsd
if %ERRORLEVEL% NEQ 0 (
