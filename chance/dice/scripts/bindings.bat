...
"E:\ACE_wrappers\bin\generate_export_file.pl" -n RPG_Dice > .\..\rpg_dice_exports.h

@rem C++ "glue code"
"E:\XML2CppCode\Debug\XML2CppCode.exe" -d RPG_Dice_Export -e -f .\..\rpg_dice.xsd -i -o .\.. -s -u -x RPG_Dice
