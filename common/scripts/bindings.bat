...
@rem C++ "glue code"
"E:\XML2CppCode\Debug\XML2CppCode.exe" -d RPG_Common_Export -e -f .\..\rpg_common.xsd -i -o .\.. -s -u -x RPG_Common
"E:\XML2CppCode\Debug\XML2CppCode.exe" -d RPG_Common_Export -e -f .\..\rpg_common_environment.xsd -i -o .\.. -s -u -x RPG_Common
