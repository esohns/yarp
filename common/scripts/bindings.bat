...
C:\Perl\bin\perl.exe C:\Temp\ACE_wrappers\bin\generate_export_file.pl -n RPG_Common > .\..\rpg_common_exports.h

@rem C++ "glue code"
C:\Tools\XML2CppCode.exe -d RPG_Common_Export -e -f .\..\rpg_common.xsd -i -o .\.. -s -u -x RPG_Common
C:\Tools\XML2CppCode.exe -d RPG_Common_Export -e -f .\..\rpg_common_environment.xsd -i -o .\.. -s -u -x RPG_Common
...
"C:\Program Files\CodeSynthesis XSD 3.3\bin\xsd.exe" cxx-parser --type-map .\..\rpg_common.map --char-type char --output-dir .\.. --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc --export-symbol "RPG_Common_Export" --hxx-prologue "#include \"rpg_common_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp .\..\rpg_common.xsd

@rem generate include/implementation (rpg_common_environment.xsd)
"C:\Program Files\CodeSynthesis XSD 3.3\bin\xsd.exe" cxx-parser --type-map .\..\rpg_common_environment.map --char-type char --output-dir .\.. --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc --export-symbol "RPG_Common_Export" --hxx-prologue "#include \"rpg_common_exports.h\"" --cxx-prologue-file .\..\stdafx.cpp .\..\rpg_common_environment.xsd
