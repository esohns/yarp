...
# C++ "glue code"
${XML2CppCodeEXE} -d RPG_Common_Export -e -f ./common/etc/rpg_common.xsd -i -o ./common -s -u -x RPG_Common
${XML2CppCodeEXE} -d RPG_Common_Export -e -f ./common/etc/rpg_common_environment.xsd -i -o ./common -s -u -x RPG_Common
...
xsdcxx cxx-parser --char-type char --output-dir ./3rd_party/xsd --xml-parser xerces --force-overwrite --generate-xml-schema --skel-file-suffix "" --hxx-suffix .h --show-anonymous --show-sloc ./common/etc/rpg_XMLSchema_XML_types.xsd
#[ $? -ne 0 ] && echo "ERROR: failed to xsdcxx, aborting" && exit 1

# generate include/implementation (rpg_common.xsd)
xsdcxx cxx-parser --type-map ./common/etc/rpg_common.map --char-type char --output-dir ./common --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc ./common/etc/rpg_common.xsd
[ $? -ne 0 ] && echo "ERROR: failed to xsdcxx, aborting" && exit 1

# generate include/implementation (rpg_common_environment.xsd)
xsdcxx cxx-parser --type-map ./common/etc/rpg_common_environment.map --char-type char --output-dir ./common --namespace-map urn:rpg= --xml-parser xerces --force-overwrite --extern-xml-schema rpg_XMLSchema.h --skel-file-suffix _XML_types --hxx-suffix .h --cxx-suffix .cpp --show-anonymous --show-sloc ./common/etc/rpg_common_environment.xsd
[ $? -ne 0 ] && echo "ERROR: failed to xsdcxx, aborting" && exit 1

# generate "XMLSchema" namespace include file (tree)
xsdcxx cxx-tree --char-type char --output-dir ./3rd_party/xsd --generate-serialization --generate-xml-schema --hxx-suffix .h --show-anonymous --show-sloc ./common/etc/rpg_XMLSchema_XML_tree.xsd
...
xsdcxx cxx-tree --generate-serialization --generate-ostream --generate-comparison --type-regex '/(.+) RPG_(.+)_Type/RPG_\u$2_XMLTree_Type/' --char-type char --output-dir ./common --namespace-map urn:rpg= --extern-xml-schema rpg_XMLSchema.h --hxx-suffix _XML_tree.h --cxx-suffix _XML_tree.cpp --show-anonymous --show-sloc --export-symbol "RPG_Common_Export" --hxx-prologue "#include \"rpg_common_exports.h\"" ./common/etc/rpg_common.xsd
...
xsdcxx cxx-tree --generate-serialization --generate-ostream --generate-comparison --type-regex '/(.+) RPG_(.+)_Type/RPG_\u$2_XMLTree_Type/' --char-type char --output-dir ./common --namespace-map urn:rpg= --extern-xml-schema rpg_XMLSchema.h --hxx-suffix _XML_tree.h --cxx-suffix _XML_tree.cpp --show-anonymous --show-sloc --export-symbol "RPG_Common_Export" --hxx-prologue "#include \"rpg_common_exports.h\"" ./common/etc/rpg_common_environment.xsd
