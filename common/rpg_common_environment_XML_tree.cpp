...
const RPG_Common_Environment_XMLTree_Type::outdoors_optional& RPG_Common_Environment_XMLTree_Type::
outdoors () const
{
  return this->outdoors_;
}

RPG_Common_Environment_XMLTree_Type::outdoors_optional& RPG_Common_Environment_XMLTree_Type::
outdoors ()
{
  return this->outdoors_;
}
...
RPG_Common_Environment_XMLTree_Type& RPG_Common_Environment_XMLTree_Type::
operator= (const RPG_Common_Environment_XMLTree_Type& x)
{
  if (this != &x)
  {
    ...
    this->climate_ = x.climate_;
    this->time_ = x.time_;
    this->lighting_ = x.lighting_;
    this->outdoors_ = x.outdoors_;
  }
...
RPG_Common_Plane_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                               ...
                               ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Common_Plane_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Common_Plane_XMLTree_Type_convert ();
}
...
RPG_Common_Terrain_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                 ...
                                 ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Common_Terrain_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Common_Terrain_XMLTree_Type_convert ();
}
...
RPG_Common_Track_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                               ...
                               ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Common_Track_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Common_Track_XMLTree_Type_convert ();
}
...
RPG_Common_Climate_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                 ...
                                 ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Common_Climate_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Common_Climate_XMLTree_Type_convert ();
}
...
RPG_Common_TimeOfDay_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                   ...
                                   ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Common_TimeOfDay_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Common_TimeOfDay_XMLTree_Type_convert ();
}
...
RPG_Common_AmbientLighting_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                         ...
                                         ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Common_AmbientLighting_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Common_AmbientLighting_XMLTree_Type_convert ();
}
       ...
       ::xml_schema::flags f)
{
...

  {
    ...
    {
      ::std::auto_ptr< terrain_type > r (
        terrain_traits::create (s, f, this));
      this->terrain_.set (r);
    }
  }

  {
    ...
    {
      ::std::auto_ptr< climate_type > r (
        climate_traits::create (s, f, this));
      this->climate_.set (r);
    }
  }
...

  {
    ...
    {
      ::std::auto_ptr< lighting_type > r (
        lighting_traits::create (s, f, this));
      this->lighting_.set (r);
    }
  }
...
{
  RPG_Common_Plane_XMLTree_Type::value v (x);
...
{
  RPG_Common_Terrain_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
...
{
  RPG_Common_Track_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
...
{
  RPG_Common_Climate_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
...
{
  RPG_Common_TimeOfDay_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
...
{
  RPG_Common_AmbientLighting_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
