...
void RPG_Common_Environment_XMLTree_Type::
climate (::std::unique_ptr< climate_type > x)
{
  this->climate_.set (std::move (x));
}
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::unique_ptr< climate_type > r (
        climate_traits::create (i, f, this));

      if (!this->climate_)
      {
        this->climate_.set (::std::move (r));
        continue;
      }
    }
    ...
    {
      ::std::unique_ptr< lighting_type > r (
        lighting_traits::create (i, f, this));

      if (!this->lighting_)
      {
        this->lighting_.set (::std::move (r));
        continue;
      }
    }
