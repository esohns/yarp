...
void RPG_Map_Door_XMLTree_Type::
outside (::std::unique_ptr< outside_type > x)
{
  this->outside_.set (std::move (x));
}
...
RPG_Map_Door_XMLTree_Type::
RPG_Map_Door_XMLTree_Type (::std::unique_ptr< position_type > position,
                           const outside_type& outside)
: ::xml_schema::type (),
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "door" && n.namespace_ () == "urn:rpg")
    {
      ...
      this->door_.push_back (::std::move (r));
      continue;
    }
...
RPG_Map_Door_State_XMLTree_Type::
RPG_Map_Door_State_XMLTree_Type (::std::unique_ptr< position_type > position,
                                 const state_type& state)
: ::xml_schema::type (),
  position_ (std::move (position), this),
  state_ (state, this)
       ...
       const ::xml_schema::properties& p)
{
  ...
  return ::std::unique_ptr< ::RPG_Map_Level_XMLTree_Type > (
    ::map_t (
       ...
       const ::xml_schema::properties& p)
{
  ...
  {
    ::std::unique_ptr< ::RPG_Map_Level_XMLTree_Type > r (
...
operator<< (::xercesc::DOMElement& e, const RPG_Map_Level_XMLTree_Type& i)
{
  ...
  for (RPG_Map_Level_XMLTree_Type::door_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Map_Level_XMLTree_Type::door_type& x (*b);
...
operator<< (::xercesc::DOMElement& e, const RPG_Map_State_XMLTree_Type& i)
{
  ...
  for (RPG_Map_State_XMLTree_Type::door_const_iterator
       ...
       b != n; ++b)
  {
    const RPG_Map_State_XMLTree_Type::door_type& x (*b);
