...
RPG_Map_DoorState_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                ...
                                ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Map_DoorState_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Map_DoorState_XMLTree_Type_convert ();
}
...
RPG_Map_Direction_XMLTree_Type (::xml_schema::istream< ACE_InputCDR >& s,
                                ...
                                ::xml_schema::container* c)
: ::xml_schema::string (
  ::xml_schema::string (_xsd_RPG_Map_Direction_XMLTree_Type_literals_[s.read_uint ()]), f, c)
{
  _xsd_RPG_Map_Direction_XMLTree_Type_convert ();
}
       ...
       ::xml_schema::flags f)
{
  ...
  {
    this->outside_.set (outside_traits::create (s, f, this));
  }
}
...
{
  RPG_Map_DoorState_XMLTree_Type::value v (x);
...
{
  RPG_Map_Direction_XMLTree_Type::value v (x);
  return s << static_cast< unsigned int > (v);
}
