...
C:\Perl\bin\perl.exe C:\Temp\ACE_wrappers\bin\generate_export_file.pl -n RPG_Map > .\..\rpg_map_exports.h

@rem C++ "glue code"
C:\Tools\XML2CppCode.exe -d RPG_Map_Export -e -f .\..\rpg_map.xsd -i -o .\.. -s -u -x RPG_Map
