...
#ifndef NET_CLIENT_EVENTHANDLER_H
#define NET_CLIENT_EVENTHANDLER_H
...
class Net_Client_EventHandler
 : public RPG_Net_Protocol_ISessionNotify_t
{
 public:
  Net_Client_EventHandler (Net_Client_GTK_CBData*); // GTK state
  inline virtual ~Net_Client_EventHandler () {}
 ...
 private:
  ACE_UNIMPLEMENTED_FUNC (Net_Client_EventHandler ())
  ACE_UNIMPLEMENTED_FUNC (Net_Client_EventHandler (const Net_Client_EventHandler&))
  ACE_UNIMPLEMENTED_FUNC (Net_Client_EventHandler& operator=(const Net_Client_EventHandler&))

  Net_Client_GTK_CBData* CBData_;
};
