...
update_layout (struct GTK_CBData& userData_in)
{
  ...
  GtkComboBox* combobox =
    GTK_COMBO_BOX (gtk_builder_get_object ((*iterator).second.second,
                                           ACE_TEXT_ALWAYS_CHAR (MAP_GENERATOR_GNOME_ENVIRONMENT_PLANE_COMBOBOX_NAME)));
  ACE_ASSERT (combobox);
  struct RPG_Engine_LevelMetaData meta_data_s =
    userData_in.currentLevel.metadata;
  gtk_combo_box_set_active (combobox,
                            meta_data_s.environment.plane);
  ...
  ACE_ASSERT (combobox);
  gtk_combo_box_set_active (combobox,
                           meta_data_s.environment.terrain);
  ...
  ACE_ASSERT (combobox);
  gtk_combo_box_set_active (combobox,
                            meta_data_s.environment.climate);
  ...
  ACE_ASSERT (combobox);
  gtk_combo_box_set_active (combobox,
                            meta_data_s.environment.lighting);
  ...
  ACE_ASSERT (togglebutton);
  gtk_toggle_button_set_active (togglebutton,
                                meta_data_s.environment.outdoors);
  ...
  for (RPG_Engine_SpawnsConstIterator_t iterator = meta_data_s.spawns.begin ();
       iterator != meta_data_s.spawns.end ();
       iterator++)
  {
    // append new (text) entry
    gtk_list_store_append (liststore, &treeiterator);
    gtk_list_store_set (liststore, &treeiterator,
                        0, (*iterator).spawn.type.c_str (), // column 0
                        -1);
  } // end FOR
  ...
  gchar* converted_text =
    Common_UI_GTK_Tools::localeToUTF8 (map_info);
  if (!converted_text)
  {
    ACE_DEBUG ((LM_ERROR,
...
//                                 ACE_TEXT_ALWAYS_CHAR("text"), 0);
       ...
       i++)
  {
    ...
    gtk_list_store_set (list, &tree_iterator,
                        0, RPG_Common_Tools::enumToString (RPG_Common_PlaneHelper::RPG_Common_PlaneToString (static_cast<RPG_Common_Plane> (i)), true).c_str (), // column 0
                       -1);
  } // end FOR
...
//                                 ACE_TEXT_ALWAYS_CHAR("text"), 0);
       ...
       i++)
  {
    ...
    gtk_list_store_append (list, &tree_iterator);
    gtk_list_store_set (list, &tree_iterator,
                       0, RPG_Common_Tools::enumToString (RPG_Common_TerrainHelper::RPG_Common_TerrainToString (static_cast<RPG_Common_Terrain> (i)), true).c_str (), // column 0
                       -1);
  } // end FOR
...
//                                 ACE_TEXT_ALWAYS_CHAR("text"), 0);
       ...
       i++)
  {
    ...
    gtk_list_store_append (list, &tree_iterator);
    gtk_list_store_set (list, &tree_iterator,
                        0, RPG_Common_Tools::enumToString (RPG_Common_ClimateHelper::RPG_Common_ClimateToString (static_cast<RPG_Common_Climate> (i)), true).c_str (), // column 0
                       -1);
  } // end FOR
...
//                                 ACE_TEXT_ALWAYS_CHAR("text"), 0);
       ...
       i++)
  {
    ...
    gtk_list_store_append (list, &tree_iterator);
    gtk_list_store_set (list, &tree_iterator,
                        0, RPG_Common_Tools::enumToString (RPG_Common_TimeOfDayHelper::RPG_Common_TimeOfDayToString (static_cast<RPG_Common_TimeOfDay> (i)), true).c_str (), // column 0
                       -1);
  } // end FOR
...
//                                 ACE_TEXT_ALWAYS_CHAR("text"), 0);
       ...
       i++)
  {
    ...
    gtk_list_store_append (list, &tree_iterator);
    gtk_list_store_set (list, &tree_iterator,
                        0, RPG_Common_Tools::enumToString (RPG_Common_AmbientLightingHelper::RPG_Common_AmbientLightingToString (static_cast<RPG_Common_AmbientLighting> (i)), true).c_str (), // column 0
                       -1);
  } // end FOR
...
//                    &main_dialog,
  ...
  gtk_file_filter_set_name (file_filter,
                            ACE_TEXT_ALWAYS_CHAR (RPG_ENGINE_GTK_LEVEL_FILTER));
  ...
  gtk_file_filter_set_name (file_filter,
                            ACE_TEXT_ALWAYS_CHAR (RPG_MAP_GTK_MAP_FILTER_NAME));
                         ...
                         gpointer userData_in)
{
  ...
  if (!data_p->isTransient)
  {
    ...
    if (response == GTK_RESPONSE_OK)
    {
      ...
      if (!gtk_combo_box_get_active_iter (repository_combobox,
                                          &selected))
      {
        ACE_DEBUG((LM_ERROR,
...
//                             -1); // reset to default
  ...
  if (conversion_error)
  {
    ...
    // clean up
    g_error_free (conversion_error); conversion_error = NULL;
