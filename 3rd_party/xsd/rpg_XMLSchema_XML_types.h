...
#ifndef CXX___RPG_XMLSCHEMA_XML_TYPES_H
#define CXX___RPG_XMLSCHEMA_XML_TYPES_H
...
namespace xml_schema
{
  ...
  // Parsing flags. See xsd/cxx/parser/xerces/elements.hxx
  // for details.
  //
  typedef ::xsd::cxx::parser::xerces::flags flags;

  // Parsing properties. See xsd/cxx/parser/xerces/elements.hxx
  // for details.
  //
  typedef ::xsd::cxx::parser::xerces::properties< char > properties;

  // Document type. See xsd/cxx/parser/xerces/elements.hxx
  // for details.
  //
...
#endif // CXX___RPG_XMLSCHEMA_XML_TYPES_H
