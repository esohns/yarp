...
#define RPG_CLIENT_GRAPHICS_MAINDIALOG_NAME       ACE_TEXT_ALWAYS_CHAR("main_dialog")
#define RPG_CLIENT_GRAPHICS_ABOUTDIALOG_NAME      ACE_TEXT_ALWAYS_CHAR("about_dialog")
